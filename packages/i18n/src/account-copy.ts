...
const EN: AccountCopy = {
  ...
  overview: {
    ...
    description: "Your Henry Onyx command center — everything across all divisions, one place.",
    walletBalance: "Wallet Balance",
    walletHint: "Shared wallet · Use across Henry Onyx services",
    ...
    shareHenryCo: "Share Henry Onyx with others",
    ...
    smartRecommendationsEmpty:
      "Keep using Henry Onyx services and recommendations will adapt to your activity.",
    ...
    recommendationDescriptions: {
      trustNext: "Unlock more actions across Henry Onyx.",
      profileNext:
  ...
  tasks: {
    ...
    blurbRisk:
      "These items gate higher-trust actions across Henry Onyx — wallet withdrawals, marketplace seller approval, employer verification. Clearing them unblocks each lane.",
    blurbActive:
      "Each row routes you to the next action with one tap. Filters, priority chips, and deeplinks are kept consistent across every Henry Onyx division.",
  ...
  security: {
    title: "Security",
    description:
      "Review recent security activity, change your password, and end Henry Onyx sessions when needed.",
    ...
    trustDescription:
      "Trust is operational across the account. It now controls higher-value business actions, moderation posture, and stronger eligibility across Henry Onyx modules.",
    ...
    whatCurrentStateBody:
      "This state determines access to higher-value workflows and business actions across Henry Onyx.",
    ...
    requirements: {
      ...
      premium: {
        ...
        activity: "Use more Henry Onyx divisions with clean outcomes.",
        overlap:
  ...
  globalSignOut: {
    title: "End every Henry Onyx session",
    description:
  ...
  activity: {
    title: "Activity",
    description: "Everything you’ve done across all Henry Onyx divisions.",
    emptyTitle: "No activity yet",
    emptyDescription:
      "Your cross-division activity will appear here as you use Henry Onyx services.",
    statusLabels: {
      pending: "Pending",
      open: "Open",
      updated: "Updated",
    ...
    filters: {
      ...
      downloadFilename: "Henry Onyx-Transaction-History.pdf",
      shareTitle: "Henry Onyx Transaction History",
      typeLabels: {
        payment: "payment",
  ...
  notifications: {
    metadata: {
      title: "Notifications",
      description: "Every Henry Onyx update — wallet, support, jobs, marketplace, care, and more — in one live inbox.",
    },
    hero: {
      eyebrow: "Henry Onyx · live notifications",
      ariaOverview: "Notifications overview",
      ariaVolume: "Notification volume",
      ariaByDivision: "By division",
      headlineZero: "Inbox zero across Henry Onyx.",
      ...
      blurbZero: "Anything Henry Onyx sends arrives here in real time — wallet, support, jobs, marketplace, care, and more.",
    ...
    emptyState: {
      ...
      inboxBody: "Activity from across Henry Onyx surfaces here as it happens.",
  ...
  calendar: {
    ...
    heroEyebrow: "Henry Onyx · cross-portal calendar",
  ...
  invoices: {
    ...
    hero: {
      ...
      blurb:
        "Every payment across Henry Onyx arrives here as a branded, downloadable PDF — care bookings, marketplace orders, studio invoices, logistics shipments, learn certificates.",
    ...
    empty: {
      ...
      description:
        "Your invoices and receipts will appear here after making payments across Henry Onyx services.",
    },
    statuses: {
      paid: "Paid",
      pending: "Pending",
  ...
  messages: {
    ...
    headlines: {
      zero: "Inbox zero across Henry Onyx.",
  ...
  wallet: {
    ...
    activity: {
      ...
      emptyBody: "Top up your wallet and your activity feed will populate here with every credit, debit, refund and bonus across Henry Onyx services.",
  ...
  support: {
    metadata: {
      title: "Support",
      description: "Get help with any Henry Onyx service.",
    },
    hero: {
      title: "Support",
      description: "Get help with any Henry Onyx service.",
  ...
  payments: {
    ...
    wallet: {
      eyebrow: "Henry Onyx Wallet",
      body: "Your Henry Onyx Wallet is always available as a payment option.",
  ...
  savedItems: {
    metadata: {
      ...
      description:
        "Items you set aside from any Henry Onyx cart, kept for 90 days with an expiry warning a week early.",
    },
    hero: {
      title: "Saved for later",
      description:
        "Items you set aside from any Henry Onyx cart. We'll keep them for 90 days and warn you a week before they expire.",
    },
    summary: {
  ...
  documents: {
    metadata: {
      title: "Documents",
      description:
        "Your receipts, certificates, contracts, and important files — kept private and accessible across every Henry Onyx division.",
    },
    hero: {
    ...
    empty: {
      ...
      description:
        "Your documents, receipts, and certificates from Henry Onyx services will be stored here.",
    },
    summary: {
    ...
    retention: {
      ...
      body: "Documents are encrypted at rest, visible only to you, and retained for the lifetime of your Henry Onyx account unless you remove them.",
    },
  },
  subscriptions: {
    metadata: {
      title: "Subscriptions",
      description:
        "Read-only summary of active plans synced from divisions across Henry Onyx.",
    },
    hero: {
  ...
  referrals: {
    metadata: {
      title: "Referrals",
      description:
        "Invite qualified customers to Henry Onyx and track rewards through pending, reviewed, and credited states.",
    },
    hero: {
      title: "Referrals",
      description:
    ...
    howItWorks: {
      ...
      step1Body:
        "Share your unique code or link. Friends who visit any Henry Onyx subdomain with your link get tracked automatically.",
    ...
    policy: {
      ...
      qualifying:
        "A qualifying conversion means the referred account completed an eligible Henry Onyx action that passed payment and trust verification.",
      enforcement:
        "Henry Onyx can hold, reverse, or cancel rewards for self-referrals, duplicate conversion loops, reversals, refunds, or suspicious reward patterns.",
      separation:
  ...
  divisionProperty: {
    ...
    hero: {
      ...
      tileFoot: {
        savedManagedTemplate: "{count} Henry Onyx-managed",
      ...
      sideBodyMuted:
        "Henry Onyx-managed listings flag with a Managed badge — review, inspection, and lease follow-ups are coordinated by the Property team.",
      ...
      state: {
        empty: {
          ...
          blurb:
            "Discover residential rentals, sale listings, and Henry Onyx-managed homes. Save your favourites and every inquiry, viewing, or listing follow-up lands here automatically.",
        },
        discover: {
    ...
    sections: {
      ...
      savedMetaTemplate: "{saved} saved · {managed} managed by Henry Onyx",
      activity: "Recent activity",
    ...
    empty: {
      ...
      savedBody:
        "Discover residential rentals, sale listings, and Henry Onyx-managed homes on Property. Anything you save lands here automatically.",
  ...
  divisionMarketplace: {
    ...
    matters: {
      ...
      application: {
        ...
        bodyDefault: "Application in Henry Onyx review queue.",
  ...
  divisionJobs: {
    ...
    hero: {
      ...
      body: "Applications, saved roles, recruiter updates, and profile readiness are linked to your Henry Onyx account.",
    ...
    profile: {
      ...
      checklist: {
        ...
        verificationDetail: "Jobs trust stays capped until your Henry Onyx account has cleared identity review.",
  ...
  divisionStudio: {
    ...
    hero: {
      ...
      sideBody: "Proposals, milestones, payment proofs, deliverables, and communication signals stay connected to the same Henry Onyx identity you use everywhere else. The dashboard below reflects the Studio team's actual progress, not a status list.",
      breakdownAriaLabel: "Activity breakdown",
    ...
    empty: {
      ...
      projectsBody: "As soon as a proposal or project is created with your Henry Onyx identity, the synced Studio room will appear here — milestones, payments, deliverables, and the next move.",
  ...
  divisionLearn: {
    ...
    extras: {
      ...
      teachingTitle: "Teach with Henry Onyx",
      statusLabel: "Status",
  ...
  addresses: {
    ...
    empty: {
      body:
        "You haven't added any addresses yet. Add your first one to enable faster checkout across Henry Onyx.",
    },
    add: {
      cta: "Add address",
  ...
  search: {
    metadata: {
      ...
      description: "Search Henry Onyx account workflows and connected division routes.",
    },
    hero: {
      title: "Search your Henry Onyx workflows.",
      description:
...
const FR: DeepPartial<AccountCopy> = {
  ...
  overview: {
    ...
    description:
      "Votre centre de commande Henry Onyx — tout, dans toutes les divisions, au même endroit.",
    walletBalance: "Solde du portefeuille",
    walletHint: "Portefeuille partagé · Utilisable dans tous les services Henry Onyx",
    notifications: "Notifications",
    ...
    shareHenryCo: "Partager Henry Onyx avec d’autres",
    transactions: "Transactions",
    ...
    smartRecommendationsEmpty:
      "Continuez à utiliser les services Henry Onyx et les recommandations s’adapteront à votre activité.",
    smartHomeEmptyFallback:
    ...
    recommendationDescriptions: {
      trustNext: "Débloquez davantage d’actions sur Henry Onyx.",
      profileNext:
      ...
      fallback:
        "Continuez à utiliser Henry Onyx et les recommandations s’adapteront à votre activité.",
    },
  },
  tasks: {
    title: "Tâches",
    ...
    blurbRisk: "Ces éléments verrouillent les actions à haute confiance sur Henry Onyx — retraits du portefeuille, validation vendeur marketplace, vérification employeur. Les résoudre débloque chaque voie.",
    blurbActive: "Chaque ligne vous mène à la prochaine action en un seul geste. Filtres, étiquettes de priorité et liens profonds restent cohérents dans toutes les divisions Henry Onyx.",
  ...
  security: {
    title: "Sécurité",
    description:
      "Examinez l’activité de sécurité récente, modifiez votre mot de passe et terminez les sessions Henry Onyx si nécessaire.",
    ...
    hero: {
      ...
      statusBlurb: {
        secure:
          "Aucun événement suspect, la vérification est saine, et chaque action à plus forte confiance proposée par Henry Onyx vous est ouverte.",
        watch:
    ...
    trustDescription:
      "La confiance est opérationnelle sur tout le compte. Elle contrôle maintenant des actions business à plus forte valeur, la posture de modération et l’éligibilité renforcée dans les modules Henry Onyx.",
    ...
    whatCurrentStateBody:
      "Cet état détermine l’accès aux flux à plus forte valeur et aux actions business dans Henry Onyx.",
    ...
    requirements: {
      ...
      premium: {
        ...
        activity:
          "Utilisez davantage de divisions Henry Onyx avec des résultats propres.",
        overlap:
  ...
  globalSignOut: {
    title: "Terminer toutes les sessions Henry Onyx",
    description:
  ...
  activity: {
    title: "Activité",
    description: "Tout ce que vous avez fait dans les divisions Henry Onyx.",
    emptyTitle: "Aucune activité pour le moment",
    emptyDescription:
      "Votre activité inter-division apparaîtra ici au fur et à mesure de votre utilisation des services Henry Onyx.",
    statusLabels: {
      pending: "En attente",
      open: "Ouvert",
      updated: "Mis à jour",
    ...
    filters: {
      ...
      downloadFilename: "Henry Onyx-Historique-Transactions.pdf",
      shareTitle: "Historique des transactions Henry Onyx",
      typeLabels: {
        payment: "paiement",
  ...
  calendar: {
    metaTitle: "Calendrier · Henry Onyx",
    metaDescription:
    ...
    heroEyebrow: "Henry Onyx · calendrier multi-portails",
  ...
  notifications: {
    metadata: {
      title: "Notifications",
      description: "Toutes les mises à jour Henry Onyx — portefeuille, support, jobs, marketplace, care, et plus — dans une boîte de réception en direct.",
    },
    hero: {
      eyebrow: "Henry Onyx · notifications en direct",
      ariaOverview: "Aperçu des notifications",
      ariaVolume: "Volume des notifications",
      ariaByDivision: "Par division",
      headlineZero: "Boîte vide à travers Henry Onyx.",
      ...
      blurbZero: "Tout ce que Henry Onyx envoie arrive ici en temps réel — portefeuille, support, jobs, marketplace, care, et plus.",
    ...
    emptyState: {
      ...
      inboxBody: "L’activité de l’ensemble de Henry Onyx apparaît ici en temps réel.",
  ...
  invoices: {
    ...
    hero: {
      ...
      blurb:
        "Chaque paiement effectué sur Henry Onyx arrive ici sous forme de PDF de marque téléchargeable — réservations Care, commandes Marketplace, factures Studio, expéditions Logistics, certificats Learn.",
    ...
    empty: {
      ...
      description:
        "Vos factures et reçus apparaîtront ici après vos paiements dans les services Henry Onyx.",
    },
    statuses: {
      paid: "Payée",
      pending: "En attente",
  ...
  messages: {
    ...
    hero: {
      eyebrow: "Henry Onyx · boîte de réception unifiée",
    ...
    headlines: {
      zero: "Boîte de réception vide à travers Henry Onyx.",
  ...
  wallet: {
    hero: {
      ...
      eyebrow: "Portefeuille Henry Onyx · en direct",
      availableLabel: "Solde disponible",
      balanceAriaTemplate: "Solde disponible {amount} {currency}",
      settlementFallback: "Réglé dans votre devise locale au taux Henry Onyx du jour.",
    ...
    activity: {
      ...
      emptyBody: "Approvisionnez votre portefeuille et votre flux affichera ici chaque crédit, débit, remboursement et bonus dans les services Henry Onyx.",
  ...
  support: {
    metadata: {
      title: "Assistance",
      description: "Obtenez de l’aide pour n’importe quel service Henry Onyx.",
    },
    hero: {
      title: "Assistance",
      description: "Obtenez de l’aide pour n’importe quel service Henry Onyx.",
  ...
  payments: {
    ...
    wallet: {
      eyebrow: "Portefeuille Henry Onyx",
      body: "Votre portefeuille Henry Onyx est toujours disponible comme moyen de paiement.",
  ...
  savedItems: {
    metadata: {
      ...
      description:
        "Articles mis de côté depuis n’importe quel panier Henry Onyx, conservés 90 jours avec un avertissement une semaine avant l’expiration.",
    },
    hero: {
      title: "Enregistrés pour plus tard",
      description:
        "Les articles que vous avez mis de côté depuis vos paniers Henry Onyx. Nous les gardons 90 jours et vous prévenons une semaine avant leur expiration.",
    },
    summary: {
  ...
  documents: {
    metadata: {
      title: "Documents",
      description:
        "Vos reçus, certificats, contrats et fichiers importants — conservés en privé et accessibles dans toutes les divisions Henry Onyx.",
    },
    hero: {
    ...
    empty: {
      ...
      description:
        "Vos documents, reçus et certificats issus des services Henry Onyx seront stockés ici.",
    },
    summary: {
      countTemplate: "{count} document{plural}",
    ...
    retention: {
      ...
      body: "Les documents sont chiffrés au repos, visibles uniquement par vous et conservés pendant toute la durée de vie de votre compte Henry Onyx sauf si vous les supprimez.",
    },
  },
  subscriptions: {
    metadata: {
      title: "Abonnements",
      description:
        "Récapitulatif en lecture seule des forfaits actifs synchronisés depuis les divisions Henry Onyx.",
    },
    hero: {
  ...
  referrals: {
    metadata: {
      title: "Parrainages",
      description:
        "Invitez des clients qualifiés sur Henry Onyx et suivez les récompenses à travers les états en attente, vérifiés et crédités.",
    },
    hero: {
      title: "Parrainages",
      description:
    ...
    howItWorks: {
      ...
      step1Body:
        "Partagez votre code ou lien unique. Les amis qui visitent un sous-domaine Henry Onyx avec votre lien sont suivis automatiquement.",
    ...
    policy: {
      ...
      qualifying:
        "Une conversion qualifiante signifie que le compte parrainé a réalisé une action Henry Onyx éligible qui a passé la vérification de paiement et de confiance.",
      enforcement:
        "Henry Onyx peut suspendre, annuler ou révoquer les récompenses en cas d’auto-parrainages, de boucles de conversion en doublon, d’annulations, de remboursements ou de schémas de récompenses suspects.",
      separation:
  ...
  divisionProperty: {
    ...
    hero: {
      ...
      tileFoot: {
        savedManagedTemplate: "{count} gérée·s par Henry Onyx",
      ...
      sideBodyMuted:
        "Les annonces gérées par Henry Onyx portent un badge Géré — vérifications, inspections et suivis de bail sont coordonnés par l’équipe Property.",
      ...
      state: {
        empty: {
          ...
          blurb:
            "Découvrez les locations résidentielles, les ventes et les biens gérés par Henry Onyx. Enregistrez vos favoris et chaque demande, visite ou suivi d’annonce arrive ici automatiquement.",
        },
        discover: {
    ...
    sections: {
      ...
      savedMetaTemplate: "{saved} enregistré·s · {managed} géré·s par Henry Onyx",
      activity: "Activité récente",
    ...
    empty: {
      ...
      savedBody:
        "Découvrez les locations résidentielles, les ventes et les biens gérés par Henry Onyx sur Property. Tout ce que vous enregistrez arrive ici automatiquement.",
  ...
  divisionMarketplace: {
    ...
    matters: {
      ...
      application: {
        ...
        bodyDefault: "Candidature dans la file de revue Henry Onyx.",
        bodyReviewSuffixTemplate: " · {note}",
        cta: "Voir le statut",
  ...
  divisionJobs: {
    ...
    hero: {
      ...
      body: "Candidatures, postes sauvegardés, mises à jour recruteurs et préparation de profil sont liés à votre compte Henry Onyx.",
    ...
    profile: {
      ...
      checklist: {
        ...
        verificationDetail: "La confiance Jobs reste plafonnée tant que votre identité Henry Onyx n’est pas validée.",
  ...
  divisionLogistics: {
    ...
    hero: {
      ...
      eyebrow: "Henry Onyx Logistique",
      brand: "Henry Onyx Logistique",
  ...
  divisionLearn: {
    ...
    extras: {
      ...
      teachingTitle: "Enseigner avec Henry Onyx",
      statusLabel: "Statut",
      expertiseLabel: "Expertise",
      topicsLabel: "Sujets",
  ...
  divisionStudio: {
    ...
    hero: {
      ...
      sideBody: "Les propositions, jalons, justificatifs de paiement, livrables et signaux d’échange restent rattachés à l’identité Henry Onyx que vous utilisez partout. Le tableau ci-dessous reflète la progression réelle de l’équipe Studio, pas une simple liste d’états.",
      breakdownAriaLabel: "Répartition de l’activité",
      breakdownLabel: "Par état",
      tiles: {
      ...
      state: {
        empty: {
          ...
          blurb: "Quand une proposition ou un projet démarre avec votre identité Henry Onyx, la salle Studio synchronisée apparaît ici — jalons, paiements, livrables et prochaine étape regroupés.",
    ...
    empty: {
      ...
      projectsBody: "Dès qu’une proposition ou un projet est créé avec votre identité Henry Onyx, la salle Studio synchronisée apparaîtra ici — jalons, paiements, livrables et prochaine étape.",
  ...
  addresses: {
    ...
    empty: {
      body:
        "Vous n'avez encore ajouté aucune adresse. Ajoutez-en une pour accélérer le paiement dans Henry Onyx.",
    },
    add: {
  ...
  search: {
    metadata: {
      ...
      description: "Recherchez les flux de votre compte Henry Onyx et les routes des divisions connectées.",
    },
    hero: {
      title: "Recherchez vos flux Henry Onyx.",
      description:
...
const DE: DeepPartial<AccountCopy> = {
  ...
  "overview": {
    ...
    "description": "Ihre Henry Onyx-Kommandozentrale – alles über alle Abteilungen hinweg an einem Ort.",
    "walletBalance": "Wallet-Guthaben",
    "walletHint": "Gemeinsame Geldbörse · Verwendung für alle Henry Onyx-Dienste",
    ...
    "shareHenryCo": "Teilen Sie Henry Onyx mit anderen",
    ...
    "smartRecommendationsEmpty": "Nutzen Sie weiterhin die Dienste von Henry Onyx und die Empfehlungen passen sich Ihrer Aktivität an.",
    ...
    "recommendationDescriptions": {
      "trustNext": "Schalten Sie weitere Aktionen über Henry Onyx frei.",
      ...
      "fallback": "Nutzen Sie weiterhin die Dienste von Henry Onyx und die Empfehlungen passen sich Ihrer Aktivität an."
    }
  },
  "tasks": {
    "title": "Aufgaben",
    ...
    "blurbRisk": "Diese Elemente blockieren Aktionen mit höherem Vertrauen über Henry Onyx hinweg — Wallet-Auszahlungen, Marketplace-Verkäufergenehmigung, Arbeitgeberverifizierung. Sie zu klären gibt jede Spur frei.",
    "blurbActive": "Jede Zeile führt Sie mit einem Tipp zur nächsten Aktion. Filter, Prioritäts-Chips und Deeplinks bleiben in allen Henry Onyx-Abteilungen konsistent.",
  ...
  "security": {
    "title": "Sicherheit",
    "description": "Überprüfen Sie die letzten Sicherheitsaktivitäten, ändern Sie Ihr Passwort und beenden Sie bei Bedarf Henry Onyx-Sitzungen.",
    ...
    "hero": {
      ...
      "statusBlurb": {
        "secure": "Keine verdächtigen Ereignisse, die Verifizierung ist gesund, und jede Aktion mit höherem Vertrauen, die Henry Onyx anbietet, steht Ihnen offen.",
    ...
    "trustDescription": "Vertrauen ist im gesamten Konto wirksam. Es steuert jetzt höherwertige Geschäftsaktionen, die Moderationshaltung und eine stärkere Berechtigung für alle Henry Onyx-Module.",
    ...
    "whatCurrentStateBody": "Dieser Status bestimmt den Zugriff auf höherwertige Workflows und Geschäftsaktionen in Henry Onyx.",
    ...
    "requirements": {
      ...
      "premium": {
        ...
        "activity": "Verwenden Sie mehr Henry Onyx-Divisionen mit sauberen Ergebnissen.",
  ...
  "activity": {
    "title": "Aktivität",
    "description": "Alles, was Sie über alle Henry Onyx-Bereiche hinweg getan haben.",
    "emptyTitle": "Noch keine Aktivität",
    "emptyDescription": "Ihre bereichsübergreifende Aktivität erscheint hier, sobald Sie Henry Onyx-Dienste nutzen.",
    "statusLabels": {
      "pending": "Ausstehend",
      "open": "Offen",
    ...
    "filters": {
      ...
      "downloadFilename": "Henry Onyx-Transaktionsverlauf.pdf",
      "shareTitle": "Henry Onyx Transaktionsverlauf",
      "typeLabels": {
        "payment": "Zahlung",
  ...
  calendar: {
    ...
    heroEyebrow: "Henry Onyx · portalübergreifender Kalender",
  ...
  notifications: {
    metadata: {
      ...
      description: "Jedes Henry Onyx-Update – Wallet, Support, Jobs, Marktplatz, Care und mehr – in einem Live-Posteingang.",
    },
    hero: {
      eyebrow: "Henry Onyx · Live-Benachrichtigungen",
      ariaOverview: "Benachrichtigungsübersicht",
      ariaVolume: "Benachrichtigungsvolumen",
      ariaByDivision: "Nach Bereich",
      headlineZero: "Posteingang null bei Henry Onyx.",
      ...
      blurbZero: "Alles, was Henry Onyx sendet, kommt hier in Echtzeit an – Wallet, Support, Jobs, Marktplatz, Care und mehr.",
    ...
    emptyState: {
      ...
      inboxBody: "Aktivitäten aus ganz Henry Onyx erscheinen hier, sobald sie eintreffen.",
  ...
  "invoices": {
    ...
    "hero": {
      ...
      "blurb": "Jede Zahlung in Henry Onyx erscheint hier als markenbezogene, herunterladbare PDF — Care-Buchungen, Marketplace-Bestellungen, Studio-Rechnungen, Logistics-Sendungen, Learn-Zertifikate.",
    ...
    "empty": {
      ...
      "description": "Ihre Rechnungen und Belege erscheinen hier, sobald Sie Zahlungen in Henry Onyx-Diensten tätigen."
    },
    "statuses": {
      "paid": "Bezahlt",
      "pending": "Ausstehend",
  ...
  messages: {
    ...
    headlines: {
      zero: "Posteingang leer in ganz Henry Onyx.",
  ...
  wallet: {
    hero: {
      ...
      eyebrow: "Henry Onyx Wallet · live",
      availableLabel: "Verfügbarer Saldo",
      balanceAriaTemplate: "Verfügbarer Saldo {amount} {currency}",
      settlementFallback: "Wird zum Henry Onyx-Tageskurs in Ihre Lokalwährung abgerechnet.",
    ...
    activity: {
      ...
      emptyBody: "Laden Sie Ihre Wallet auf, und Ihr Aktivitätsfeed zeigt hier jede Gutschrift, Belastung, Rückerstattung und jeden Bonus über alle Henry Onyx-Dienste.",
  ...
  support: {
    metadata: {
      title: "Support",
      description: "Erhalten Sie Unterstützung für jeden Henry Onyx-Dienst.",
    },
    hero: {
      title: "Support",
      description: "Erhalten Sie Unterstützung für jeden Henry Onyx-Dienst.",
  ...
  payments: {
    ...
    wallet: {
      eyebrow: "Henry Onyx Wallet",
      body: "Ihre Henry Onyx Wallet steht jederzeit als Zahlungsoption zur Verfügung.",
  ...
  savedItems: {
    metadata: {
      ...
      description:
        "Artikel, die Sie aus einem Henry Onyx-Warenkorb beiseitegelegt haben — 90 Tage aufbewahrt, mit Hinweis eine Woche vor Ablauf.",
    },
    hero: {
      title: "Für später gespeichert",
      description:
        "Artikel, die Sie aus einem Henry Onyx-Warenkorb beiseitegelegt haben. Wir bewahren sie 90 Tage auf und warnen Sie eine Woche vor Ablauf.",
    },
    summary: {
  ...
  documents: {
    metadata: {
      title: "Dokumente",
      description:
        "Ihre Quittungen, Zertifikate, Verträge und wichtigen Dateien — privat aufbewahrt und in jedem Henry Onyx-Bereich abrufbar.",
    },
    hero: {
    ...
    empty: {
      ...
      description:
        "Ihre Dokumente, Quittungen und Zertifikate aus Henry Onyx-Diensten werden hier gespeichert.",
    },
    summary: {
    ...
    retention: {
      ...
      body: "Dokumente werden ruhend verschlüsselt, sind nur für Sie sichtbar und bleiben für die Laufzeit Ihres Henry Onyx-Kontos erhalten, sofern Sie sie nicht entfernen.",
    },
  },
  subscriptions: {
    metadata: {
      title: "Abonnements",
      description:
        "Schreibgeschützte Übersicht aller aktiven Pläne, synchronisiert aus den Henry Onyx-Bereichen.",
    },
    hero: {
  ...
  referrals: {
    metadata: {
      title: "Empfehlungen",
      description:
        "Laden Sie qualifizierte Kunden zu Henry Onyx ein und verfolgen Sie Prämien von ausstehend über geprüft bis gutgeschrieben.",
    },
    hero: {
      title: "Empfehlungen",
      description:
    ...
    howItWorks: {
      ...
      step1Body:
        "Teilen Sie Ihren einzigartigen Code oder Link. Freunde, die mit Ihrem Link eine Henry Onyx-Subdomain besuchen, werden automatisch erfasst.",
    ...
    policy: {
      ...
      qualifying:
        "Eine qualifizierende Conversion bedeutet, dass das geworbene Konto eine berechtigte Henry Onyx-Aktion abgeschlossen hat, die die Zahlungs- und Vertrauensprüfung bestanden hat.",
      enforcement:
        "Henry Onyx kann Prämien für Selbstempfehlungen, doppelte Conversion-Schleifen, Stornos, Rückerstattungen oder verdächtige Prämienmuster zurückhalten, rückgängig machen oder stornieren.",
      separation:
  ...
  divisionCare: {
    metadata: {
      ...
      description: "Verfolgen Sie jede Henry Onyx-Care-Buchung, die mit diesem Konto verknüpft ist – Status, Zahlungsprüfung und der nächste betriebliche Schritt an einem Ort.",
    },
    hero: {
      eyebrow: "Care · live",
  ...
  divisionProperty: {
    ...
    hero: {
      ...
      tileFoot: {
        savedManagedTemplate: "{count} von Henry Onyx verwaltet",
      ...
      sideBodyMuted:
        "Von Henry Onyx verwaltete Inserate tragen einen Verwaltet-Badge — Prüfung, Inspektion und Mietabwicklung werden vom Property-Team koordiniert.",
      ...
      state: {
        empty: {
          ...
          blurb:
            "Entdecken Sie Mietwohnungen, Verkaufsangebote und von Henry Onyx verwaltete Objekte. Merken Sie Ihre Favoriten — jede Anfrage, Besichtigung oder Inseratsmeldung landet automatisch hier.",
        },
        discover: {
    ...
    sections: {
      ...
      savedMetaTemplate: "{saved} gemerkt · {managed} von Henry Onyx verwaltet",
    ...
    empty: {
      ...
      savedBody:
        "Entdecken Sie Mietwohnungen, Verkaufsangebote und von Henry Onyx verwaltete Objekte auf Property. Alles, was Sie merken, landet automatisch hier.",
  ...
  divisionJobs: {
    metadata: {
      ...
      description: "Verfolgen Sie jede mit diesem Konto verknüpfte Henry Onyx-Jobs-Bewerbung, gemerkte Stelle, Recruiter-Aktualisierung und Profilbereitschaft.",
    },
    header: {
      title: "Jobs",
    ...
    hero: {
      ...
      body: "Bewerbungen, gemerkte Stellen, Recruiter-Updates und Profilbereitschaft sind mit Ihrem Henry Onyx-Konto verknüpft.",
    ...
    profile: {
      ...
      checklist: {
        ...
        verificationDetail: "Das Jobs-Vertrauen bleibt begrenzt, bis Ihr Henry Onyx-Konto die Identitätsprüfung bestanden hat.",
  ...
  divisionMarketplace: {
    metadata: {
      ...
      description: "Verfolgen Sie jede Henry Onyx-Marketplace-Bestellung, jeden Streitfall und jede Verkäuferauszahlung, die mit diesem Konto verknüpft ist – Käuferaktivität und Verkäufer-Workspace gespiegelt in einem Raum, in Echtzeit.",
    },
    hero: {
      eyebrow: "Marketplace · live",
    ...
    matters: {
      ...
      application: {
        ...
        bodyDefault: "Bewerbung in der Henry Onyx-Prüfwarteschlange.",
        bodyReviewSuffixTemplate: " · {note}",
        cta: "Status ansehen",
  ...
  "divisionLogistics": {
    "metadata": {
      ...
      "description": "Jede Abholung, Zustellung, ETA und Liefernachweis von Henry Onyx Logistik, die mit diesem Konto verknüpft sind — vom Logistiknetz in einen ruhigen Raum gespiegelt."
    },
    "hero": {
      "ariaLabel": "Logistik-Überblick",
      "eyebrow": "Henry Onyx Logistik",
      "brand": "Henry Onyx Logistik",
  ...
  "divisionLearn": {
    "metadata": {
      ...
      "description": "Verfolgen Sie jede Henry Onyx-Learn-Einschreibung, Lektion, Quizergebnis, Zertifizierung, zugewiesene Schulung und Lehrbewerbung, die mit diesem Konto verknüpft ist – Katalog auf Learn, Fortschritt hier gespiegelt."
    },
    "hero": {
      ...
      "state": {
        "empty": {
          "headline": "Starten Sie Ihre Henry Onyx-Learn-Reise.",
    ...
    "sections": {
      ...
      "coursesMetaEmpty": "Durchsuchen Sie den Henry Onyx-Learn-Katalog und schreiben Sie sich in Ihren ersten Kurs ein.",
    ...
    "extras": {
      ...
      "teachingTitle": "Mit Henry Onyx unterrichten",
      "statusLabel": "Status",
  ...
  divisionStudio: {
    metadata: {
      ...
      description: "Verfolgen Sie jede Henry Onyx-Studio-Zusammenarbeit, die mit diesem Konto verknüpft ist — Angebote, Meilensteine, Zahlungen, Lieferobjekte und Aktivitäten in einem Raum.",
    },
    hero: {
      eyebrowLive: "Studio · live",
      ...
      sideBody: "Angebote, Meilensteine, Zahlungsnachweise, Lieferobjekte und Kommunikationssignale bleiben mit derselben Henry Onyx-Identität verbunden, die Sie überall verwenden. Das Dashboard unten zeigt den tatsächlichen Fortschritt des Studio-Teams – keine Statusliste.",
      breakdownAriaLabel: "Aktivitätsaufschlüsselung",
      breakdownLabel: "Nach Status",
      tiles: {
      ...
      state: {
        empty: {
          ...
          blurb: "Wenn ein Angebot oder Projekt mit Ihrer Henry Onyx-Identität live geht, erscheint hier der synchronisierte Studio-Raum — Meilensteine, Zahlungen, Lieferobjekte und der nächste Schritt zusammen.",
    ...
    empty: {
      ...
      projectsBody: "Sobald ein Angebot oder Projekt mit Ihrer Henry Onyx-Identität erstellt wird, erscheint hier der synchronisierte Studio-Raum — Meilensteine, Zahlungen, Lieferobjekte und der nächste Schritt.",
  ...
  addresses: {
    ...
    empty: {
      body:
        "Sie haben noch keine Adressen hinzugefügt. Fügen Sie Ihre erste hinzu, um den Checkout über Henry Onyx zu beschleunigen.",
    },
    add: {
  ...
  search: {
    metadata: {
      ...
      description:
        "Durchsuchen Sie Henry Onyx-Konto-Workflows und verbundene Abteilungs-Routen.",
    },
    hero: {
      title: "Durchsuchen Sie Ihre Henry Onyx-Workflows.",
      description:
...
const IT: DeepPartial<AccountCopy> = {
  ...
  "overview": {
    ...
    "description": "Il tuo centro di comando Henry Onyx: tutto in tutte le divisioni, in un unico posto.",
    "walletBalance": "Saldo del portafoglio",
    "walletHint": "Portafoglio condiviso · Utilizzo tra i servizi Henry Onyx",
    ...
    "shareHenryCo": "Condividi Henry Onyx con altri",
    ...
    "smartRecommendationsEmpty": "Continua a utilizzare i servizi Henry Onyx e i consigli si adatteranno alla tua attività.",
    ...
    "recommendationDescriptions": {
      "trustNext": "Sblocca più azioni su Henry Onyx.",
      ...
      "fallback": "Continua a utilizzare i servizi Henry Onyx e i consigli si adatteranno alla tua attività."
    }
  },
  "tasks": {
    "title": "Compiti",
    ...
    "blurbRisk": "Questi elementi bloccano le azioni a maggiore fiducia in Henry Onyx — prelievi dal portafoglio, approvazione venditore marketplace, verifica datore di lavoro. Risolverli sblocca ciascuna corsia.",
    "blurbActive": "Ogni riga ti porta alla prossima azione con un solo tocco. Filtri, etichette di priorità e collegamenti restano coerenti in tutte le divisioni Henry Onyx.",
  ...
  "security": {
    "title": "Sicurezza",
    "description": "Controlla l'attività di sicurezza recente, modifica la password e termina le sessioni Henry Onyx quando necessario.",
    ...
    "hero": {
      ...
      "statusBlurb": {
        "secure": "Nessun evento sospetto, la verifica è solida e ogni azione a maggiore fiducia offerta da Henry Onyx è aperta per te.",
    ...
    "trustDescription": "La fiducia è operativa in tutto l'account. Ora controlla le azioni aziendali di valore più elevato, la postura di moderazione e un'idoneità più forte per i moduli Henry Onyx.",
    ...
    "whatCurrentStateBody": "Questo stato determina l'accesso a flussi di lavoro e azioni aziendali di valore superiore in Henry Onyx.",
    ...
    "requirements": {
      ...
      "premium": {
        ...
        "activity": "Utilizza più divisioni Henry Onyx con risultati puliti.",
  ...
  "activity": {
    "title": "Attività",
    "description": "Tutto ciò che hai fatto in tutte le divisioni Henry Onyx.",
    "emptyTitle": "Nessuna attività al momento",
    "emptyDescription": "La tua attività tra le divisioni apparirà qui man mano che usi i servizi Henry Onyx.",
    "statusLabels": {
      "pending": "In attesa",
      "open": "Aperto",
      "updated": "Aggiornato",
    ...
    "filters": {
      ...
      "downloadFilename": "Henry Onyx-Storico-Transazioni.pdf",
      "shareTitle": "Storico transazioni Henry Onyx",
      "typeLabels": {
        "payment": "pagamento",
  ...
  notifications: {
    metadata: {
      title: "Notifiche",
      description: "Ogni aggiornamento Henry Onyx — wallet, supporto, lavori, marketplace, care e altro — in una casella in tempo reale.",
    },
    hero: {
      eyebrow: "Henry Onyx · notifiche in tempo reale",
      ariaOverview: "Panoramica notifiche",
      ariaVolume: "Volume notifiche",
      ariaByDivision: "Per divisione",
      headlineZero: "Casella azzerata su Henry Onyx.",
      ...
      blurbZero: "Tutto ciò che Henry Onyx invia arriva qui in tempo reale — wallet, supporto, lavori, marketplace, care e altro.",
    ...
    emptyState: {
      ...
      inboxBody: "L’attività di tutto Henry Onyx appare qui non appena accade.",
  ...
  calendar: {
    ...
    heroEyebrow: "Henry Onyx · calendario multi-portale",
  ...
  invoices: {
    ...
    hero: {
      ...
      blurb:
        "Ogni pagamento su Henry Onyx atterra qui come PDF di marca scaricabile — prenotazioni Care, ordini Marketplace, fatture Studio, spedizioni Logistics, certificati Learn.",
    ...
    empty: {
      ...
      description:
        "Le tue fatture e ricevute appariranno qui dopo aver effettuato pagamenti nei servizi Henry Onyx.",
    },
    statuses: {
      paid: "Pagata",
      pending: "In sospeso",
  ...
  messages: {
    ...
    headlines: {
      zero: "Casella vuota in tutta Henry Onyx.",
  ...
  wallet: {
    hero: {
      ...
      eyebrow: "Portafoglio Henry Onyx · live",
      availableLabel: "Saldo disponibile",
      balanceAriaTemplate: "Saldo disponibile {amount} {currency}",
      settlementFallback: "Liquidato nella tua valuta locale al tasso Henry Onyx del giorno.",
    ...
    activity: {
      ...
      emptyBody: "Ricarica il tuo portafoglio e il flusso di attività mostrerà ogni accredito, addebito, rimborso e bonus tra i servizi Henry Onyx.",
  ...
  support: {
    metadata: {
      title: "Assistenza",
      description: "Ricevi aiuto per qualsiasi servizio Henry Onyx.",
    },
    hero: {
      title: "Assistenza",
      description: "Ricevi aiuto per qualsiasi servizio Henry Onyx.",
  ...
  payments: {
    ...
    wallet: {
      eyebrow: "Portafoglio Henry Onyx",
      body: "Il tuo portafoglio Henry Onyx è sempre disponibile come opzione di pagamento.",
  ...
  savedItems: {
    metadata: {
      ...
      description:
        "Articoli messi da parte da un carrello Henry Onyx, conservati per 90 giorni con un avviso una settimana prima della scadenza.",
    },
    hero: {
      title: "Salvati per dopo",
      description:
        "Articoli messi da parte da un carrello Henry Onyx. Li conserviamo per 90 giorni e ti avvisiamo una settimana prima della scadenza.",
    },
    summary: {
  ...
  documents: {
    metadata: {
      title: "Documenti",
      description:
        "Le tue ricevute, certificati, contratti e file importanti — custoditi privatamente e accessibili in ogni divisione Henry Onyx.",
    },
    hero: {
    ...
    empty: {
      ...
      description:
        "I tuoi documenti, ricevute e certificati dei servizi Henry Onyx saranno conservati qui.",
    },
    summary: {
    ...
    retention: {
      ...
      body: "I documenti sono cifrati a riposo, visibili solo a te e conservati per tutta la durata del tuo account Henry Onyx, salvo eliminazione.",
    },
  },
  subscriptions: {
    metadata: {
      title: "Abbonamenti",
      description:
        "Riepilogo in sola lettura dei piani attivi sincronizzati dalle divisioni Henry Onyx.",
    },
    hero: {
  ...
  referrals: {
    metadata: {
      title: "Referenze",
      description:
        "Invita clienti qualificati su Henry Onyx e segui i premi attraverso gli stati in sospeso, verificati e accreditati.",
    },
    hero: {
      title: "Referenze",
      description:
    ...
    howItWorks: {
      ...
      step1Body:
        "Condividi il tuo codice o link unico. Gli amici che visitano un sottodominio Henry Onyx con il tuo link vengono tracciati automaticamente.",
    ...
    policy: {
      ...
      qualifying:
        "Una conversione qualificante significa che l’account segnalato ha completato un’azione Henry Onyx idonea che ha superato la verifica di pagamento e di affidabilità.",
      enforcement:
        "Henry Onyx può sospendere, annullare o cancellare i premi in caso di auto-referenze, cicli di conversione duplicati, storni, rimborsi o schemi di premi sospetti.",
      separation:
  ...
  divisionProperty: {
    ...
    hero: {
      ...
      tileFoot: {
        savedManagedTemplate: "{count} gestiti da Henry Onyx",
      ...
      sideBodyMuted:
        "Gli annunci gestiti da Henry Onyx riportano un badge Gestito — verifiche, ispezioni e seguiti di locazione sono coordinati dal team Property.",
      ...
      state: {
        empty: {
          ...
          blurb:
            "Scopri locazioni residenziali, annunci di vendita e immobili gestiti da Henry Onyx. Salva i tuoi preferiti e ogni richiesta, visita o seguito di annuncio arriva qui automaticamente.",
        },
        discover: {
    ...
    sections: {
      ...
      savedMetaTemplate: "{saved} salvati · {managed} gestiti da Henry Onyx",
      activity: "Attività recente",
    ...
    empty: {
      ...
      savedBody:
        "Scopri locazioni residenziali, annunci di vendita e immobili gestiti da Henry Onyx su Property. Tutto ciò che salvi arriva qui automaticamente.",
  ...
  divisionJobs: {
    ...
    hero: {
      ...
      body: "Candidature, ruoli salvati, aggiornamenti dei recruiter e prontezza del profilo sono collegati al tuo account Henry Onyx.",
    ...
    profile: {
      ...
      checklist: {
        ...
        verificationDetail: "La fiducia Jobs resta limitata finché il tuo account Henry Onyx non supera la verifica di identità.",
  ...
  divisionMarketplace: {
    ...
    matters: {
      ...
      application: {
        ...
        bodyDefault: "Candidatura nella coda di revisione Henry Onyx.",
        bodyReviewSuffixTemplate: " · {note}",
        cta: "Vedi stato",
  ...
  divisionLearn: {
    ...
    extras: {
      ...
      teachingTitle: "Insegna con Henry Onyx",
      statusLabel: "Stato",
  ...
  divisionLogistics: {
    ...
    hero: {
      ...
      eyebrow: "Henry Onyx Logistica",
      brand: "Henry Onyx Logistica",
  ...
  divisionStudio: {
    ...
    hero: {
      ...
      sideBody: "Proposte, milestone, prove di pagamento, deliverable e segnali di comunicazione restano collegati alla stessa identità Henry Onyx che usi ovunque. La dashboard sotto riflette l’avanzamento reale del team Studio, non una semplice lista di stati.",
      ...
      state: {
        empty: {
          ...
          blurb: "Quando una proposta o un progetto parte con la tua identità Henry Onyx, la sala Studio sincronizzata appare qui — milestone, pagamenti, deliverable e prossima mossa insieme.",
    ...
    empty: {
      ...
      projectsBody: "Appena una proposta o un progetto viene creato con la tua identità Henry Onyx, la sala Studio sincronizzata apparirà qui — milestone, pagamenti, deliverable e prossima mossa.",
  ...
  addresses: {
    ...
    empty: {
      body:
        "Non hai ancora aggiunto indirizzi. Aggiungine uno per velocizzare il checkout in tutto Henry Onyx.",
    },
    add: {
  ...
  search: {
    metadata: {
      ...
      description:
        "Cerca flussi di lavoro dell'account Henry Onyx e percorsi collegati delle divisioni.",
    },
    hero: {
      title: "Cerca nei tuoi flussi Henry Onyx.",
      description:
...
const IG: DeepPartial<AccountCopy> = {
  ...
  overview: {
    ...
    description: "Ọdụ ọchịchọ Henry Onyx gị — ihe niile n'ịdị ìhè niile, otu ebe.",
    walletBalance: "Ego nọ n'akpa gị",
    walletHint: "Akpa ego nkekọrịta · Jiri n'ọrụ Henry Onyx",
    notifications: "Ọkwa",
    ...
    shareHenryCo: "Kekọrịta Henry Onyx na ndị ọzọ",
    ...
    smartRecommendationsEmpty: "Nọgide na-eji ọrụ Henry Onyx ma ndụmọdụ ga-atọ dị na arụmọrụ gị.",
    smartHomeEmptyFallback:
  ...
  tasks: {
    ...
    blurbRisk: "Ihe ndị a na-egbochi omume ntụkwasị obi dị elu na Henry Onyx — mwepụ akpa ego, nkwado onye na-ere ahịa Marketplace, nyocha onye na-ewe ọrụ. Idozi ha na-emeghe ụzọ ọ bụla.",
    blurbActive: "Ahịrị ọ bụla na-eduga gị na omume na-esote n'otu otu. Nzacha, mkpado isi mkpa, na njikọ na-anọgide kwekọrịtara na ngalaba Henry Onyx niile.",
  ...
  security: {
    title: "Nchedo",
    description: "Nyochaa omume nchedo ọgbọ ọhụrụ, gbanwee paswọọdụ gị, wee kwụsị nnọkọ Henry Onyx mgbe achọrọ.",
    ...
    hero: {
      ...
      statusBlurb: {
        secure: "Ọ dịghị ihe omume na-enyo enyo, nyocha nọ n'ezi ọnọdụ, omume ntụkwasị obi ọ bụla Henry Onyx na-enye meghere gị.",
    ...
    trustDescription: "Ntụkwasị obi na-arụ ọrụ n'akaụntụ. Ugbu a na-achịkwa omume azụmahịa nwere ọnụahịa dị elu, ọnọdụ nlekọta, na ikike siri ike n'ọcha Henry Onyx niile.",
    ...
    whatCurrentStateBody: "Ọnọdụ a na-ekpebi nnabata ihe arụ ọrụ dị elu na omume azụmahịa n'Henry Onyx.",
    ...
    requirements: {
      ...
      premium: {
        ...
        activity: "Jiri ịdị ìhè Henry Onyx ndị ọzọ na nsonaazụ dị ọcha.",
  ...
  activity: {
    title: "Mmemme",
    description: "Ihe niile ị mere n'ime ngalaba Henry Onyx niile.",
    emptyTitle: "Enwebeghị mmemme",
    emptyDescription:
      "Mmemme gị n'etiti ngalaba ga-apụta ebe a ka ị na-eji ọrụ Henry Onyx.",
    statusLabels: {
      pending: "Na-eche",
      open: "Mepere emepe",
      updated: "Mwughari",
    ...
    filters: {
      ...
      downloadFilename: "Henry Onyx-Akụkọ-Azụmahịa.pdf",
      shareTitle: "Akụkọ Azụmahịa Henry Onyx",
      typeLabels: {
        payment: "ịkwụ ụgwọ",
  ...
  notifications: {
    metadata: {
      title: "Ọkwa",
      description: "Mmelite Henry Onyx ọ bụla — obere akpa ego, nkwado, ọrụ, ahịa, nlekọta, na ihe ndị ọzọ — n’otu igbe ozi nke na-eru ugbu a.",
    },
    hero: {
      eyebrow: "Henry Onyx · ọkwa dị ndụ",
      ariaOverview: "Nlebanya ọkwa",
      ariaVolume: "Olu ọkwa",
      ariaByDivision: "Site na ngalaba",
      headlineZero: "Igbe ozi efu n’ofe Henry Onyx.",
      ...
      blurbZero: "Ihe ọ bụla Henry Onyx zigara na-aba ebe a n’oge ozugbo — obere akpa ego, nkwado, ọrụ, ahịa, nlekọta, na ihe ndị ọzọ.",
    ...
    emptyState: {
      ...
      inboxBody: "Mmemme sitere n’ofe Henry Onyx na-apụta ebe a ozugbo ọ na-eme.",
  ...
  calendar: {
    ...
    heroEyebrow: "Henry Onyx · kalịnda ụlọ ọrụ niile",
  ...
  invoices: {
    ...
    hero: {
      ...
      blurb:
        "Ịkwụ ụgwọ ọ bụla na Henry Onyx na-arute ebe a dị ka PDF nwere akara nke a ga-ebudata — ndokwa Care, iwu Marketplace, ụgwọ Studio, mbupu Logistics, akwụkwọ Learn.",
    ...
    empty: {
      ...
      description:
        "Ụgwọ ọrụ na akwụkwọ nnata gị ga-apụta ebe a mgbe ị kwụchara ụgwọ na ọrụ Henry Onyx.",
    },
    statuses: {
      paid: "Akwụgoro",
      pending: "Na-echere",
  ...
  messages: {
    ...
    headlines: {
      zero: "Igbe ozi ọcha n’ofe Henry Onyx niile.",
  ...
  wallet: {
    hero: {
      ...
      eyebrow: "Obere akpa ego Henry Onyx · na-aga",
      availableLabel: "Ego dị nri",
      balanceAriaTemplate: "Ego dị nri {amount} {currency}",
      settlementFallback: "A na-akwụ ya na ego obodo gị site na ọnụego Henry Onyx ụbọchị.",
    ...
    activity: {
      ...
      emptyBody: "Tinye ego n'obere akpa gị, ndepụta mmemme gị ga-egosi ebe a kredit, debit, nlọghachi azụ na bonus ọ bụla n'ofe ọrụ Henry Onyx.",
  ...
  support: {
    metadata: {
      title: "Nkwado",
      description: "Nweta enyemaka maka ọrụ Henry Onyx ọ bụla.",
    },
    hero: {
      title: "Nkwado",
      description: "Nweta enyemaka maka ọrụ Henry Onyx ọ bụla.",
  ...
  payments: {
    ...
    wallet: {
      eyebrow: "Akpa ego Henry Onyx",
      body: "Akpa ego Henry Onyx gị dị mgbe niile dị ka nhọrọ ịkwụ ụgwọ.",
  ...
  savedItems: {
    metadata: {
      title: "Ihe echekwara",
      description:
        "Ihe ndị i wepụrụ na nkata Henry Onyx ọ bụla, anyị na-edobere gị ụbọchị iri itoolu ma na-adọ aka na ntị otu izu tupu ha agwụ.",
    },
    hero: {
      title: "Chekwa maka mgbe ọzọ",
      description:
        "Ihe ndị i wepụrụ na nkata Henry Onyx ọ bụla. Anyị ga-edobere gị ha ụbọchị iri itoolu ma dọọ gị aka na ntị otu izu tupu ha agwụ.",
    },
    summary: {
  ...
  documents: {
    metadata: {
      title: "Akwụkwọ",
      description:
        "Akwụkwọ nnata gị, asambodo, nkwekọrịta na faịlụ ndị dị mkpa — e debere ha na nzuzo ma na-enweta ha n’ime ngalaba Henry Onyx niile.",
    },
    hero: {
    ...
    empty: {
      ...
      description:
        "Akwụkwọ gị, akwụkwọ nnata na asambodo sitere na ọrụ Henry Onyx ga-anọ ebe a.",
    },
    summary: {
    ...
    retention: {
      ...
      body: "A na-ezo akwụkwọ niile mgbe ezubeghị ọrụ, naanị gị ka ọ na-egosi, anyị na-edebe ha ruo mgbe akaụntụ Henry Onyx gị dị ndụ ma ọ bụrụ na i wepụghị ha.",
    },
  },
  subscriptions: {
    metadata: {
      title: "Ndenye aha",
      description:
        "Nchịkọta naanị-agụ nke atụmatụ na-arụ ọrụ, ndị si na ngalaba Henry Onyx dị iche iche bịa.",
    },
    hero: {
  ...
  referrals: {
    metadata: {
      title: "Ndị Ezịgara",
      description:
        "Kpọọ ndị ahịa ruru eru gaa Henry Onyx ma soro ụgwọ ọrụ site na ọnọdụ na-eche, enyochara, na akwụnyere.",
    },
    hero: {
      title: "Ndị Ezịgara",
      description:
    ...
    howItWorks: {
      ...
      step1Body:
        "Kekọrịta koodu pụrụ iche gị ma ọ bụ njikọ. Ndị enyi na-eji njikọ gị aga ngalaba ọ bụla nke Henry Onyx ka a na-esoso ozugbo.",
    ...
    policy: {
      eyebrow: "Iwu Nzipu",
      qualifying:
        "Mgbanwe ruru eru pụtara na akaụntụ ezigara mechara omume Henry Onyx kwesịrị ekwesị nke gabigara ịkwụ ụgwọ na nyocha ntụkwasị obi.",
      enforcement:
        "Henry Onyx nwere ike ijigide, gbanwee, ma ọ bụ kagbuo ụgwọ ọrụ maka nzipu onwe, akagharị mgbanwe ndabara, mgbagharị, nkwụghachi, ma ọ bụ usoro ụgwọ ọrụ enyo.",
      separation:
  ...
  divisionProperty: {
    ...
    hero: {
      ...
      tileFoot: {
        savedManagedTemplate: "{count} Henry Onyx na-elekọta",
      ...
      sideBodyMuted:
        "Ndepụta Henry Onyx na-elekọta na-egosi akara Elekọta — nleba anya, nyocha, na nsogharị mgbazinye na-anabata site n’òtù Property.",
      ...
      state: {
        empty: {
          ...
          blurb:
            "Chọpụta ụlọ obibi, ndepụta ire ahịa, na ụlọ ndị Henry Onyx na-elekọta. Dobe ndị ị masịrị, ajụjụ ọ bụla, nleta, ma ọ bụ nsogharị ndepụta na-arute ebe a n’onwe ya.",
        },
        discover: {
    ...
    sections: {
      ...
      savedMetaTemplate: "{saved} edobere · {managed} Henry Onyx na-elekọta",
    ...
    empty: {
      ...
      savedBody:
        "Chọpụta ụlọ obibi, ndepụta ire ahịa, na ụlọ ndị Henry Onyx na-elekọta na Property. Ihe ọ bụla i dobere na-arute ebe a n’onwe ya.",
  ...
  divisionMarketplace: {
    ...
    matters: {
      ...
      application: {
        ...
        bodyDefault: "Akwụkwọ n’ahịrị nyocha Henry Onyx.",
        bodyReviewSuffixTemplate: " · {note}",
        cta: "Lelee ọnọdụ",
  ...
  divisionJobs: {
    ...
    hero: {
      ...
      body: "Aplikeshọn, ọrụ edobere, nleba anya nke ndị na-achọ ndị ọrụ, na njikere profaịlụ ejikọtara na akaụntụ Henry Onyx gị.",
    ...
    profile: {
      ...
      checklist: {
        ...
        verificationDetail: "Ntụkwasị obi Jobs ga-akwụsị ruo mgbe akaụntụ Henry Onyx gị wepụrụ nyocha njirimara.",
  ...
  divisionLearn: {
    ...
    extras: {
      ...
      teachingTitle: "Kụzie ya Henry Onyx",
      statusLabel: "Ọnọdụ",
  ...
  divisionLogistics: {
    ...
    hero: {
      ...
      eyebrow: "Henry Onyx Mbufe",
      brand: "Henry Onyx Mbufe",
  ...
  divisionStudio: {
    metadata: {
      ...
      description: "Soro ọrụ Studio Henry Onyx ọ bụla ejikọtara na akaụntụ a — atụmatụ, isi ihe, ụgwọ, akụrụngwa nweere, na ọrụ na otu ụlọ.",
    },
    hero: {
      ...
      sideBody: "Atụmatụ, isi ihe, akwụkwọ akaebe ụgwọ, akụrụngwa nweere na ngosipụta nkwekọrịta na-anọgide ejikọtara na njirimara Henry Onyx ahụ ị na-eji n’ebe ọ bụla. Dashboard dị n’okpuru na-egosi ihe ndị otu Studio na-eme n’ezie, ọ bụghị ndepụta ọnọdụ.",
      breakdownAriaLabel: "Nkewa ọrụ",
      breakdownLabel: "Site n’ọnọdụ",
      tiles: {
      ...
      state: {
        empty: {
          ...
          blurb: "Mgbe atụmatụ ma ọ bụ ọrụ malitere site na njirimara Henry Onyx gị, ụlọ Studio ahụ ejikọtara ga-apụta ebe a — isi ihe, ụgwọ, akụrụngwa na nzọụkwụ ọzọ na otu ebe.",
    ...
    empty: {
      ...
      projectsBody: "Mgbe e mepụtara atụmatụ ma ọ bụ ọrụ site na njirimara Henry Onyx gị, ụlọ Studio ejikọtara ga-apụta ebe a — isi ihe, ụgwọ, akụrụngwa na nzọụkwụ ọzọ.",
  ...
  addresses: {
    ...
    empty: {
      body:
        "I tinyebeghị adreesị ọ bụla. Tinye nke mbụ gị ka i nwee mmechi ngwa ngwa na Henry Onyx.",
    },
    add: {
      cta: "Tinye adreesị",
  ...
  search: {
    metadata: {
      title: "Chọọ Akaụntụ",
      description: "Chọọ ọrụ akaụntụ Henry Onyx na ụzọ ngalaba ejikọtara.",
    },
    hero: {
      title: "Chọọ ọrụ Henry Onyx gị.",
      description:
...
const YO: DeepPartial<AccountCopy> = {
  ...
  overview: {
    ...
    description: "Ile-iṣẹ aṣẹ Henry Onyx rẹ — ohun gbogbo kọja gbogbo awọn ẹka, ibi kan.",
    walletBalance: "Iwọntunwọnsi apamọ",
    walletHint: "Apamọ ti a pin · Lo kọja awọn iṣẹ Henry Onyx",
    ...
    shareHenryCo: "Pin Henry Onyx pẹlu awọn omiiran",
    ...
    smartRecommendationsEmpty: "Tẹsiwaju lilo awọn iṣẹ Henry Onyx ati awọn iṣeduro yoo ṣe deede si iṣẹ rẹ.",
    smartHomeEmptyFallback:
    ...
    recommendationDescriptions: {
      trustNext: "Ṣii awọn iṣe diẹ sii kọja Henry Onyx.",
      ...
      fallback: "Tẹsiwaju lilo awọn iṣẹ Henry Onyx ati awọn iṣeduro yoo ṣe deede si iṣẹ rẹ.",
    },
  },
  tasks: {
    title: "Awọn iṣẹ",
    ...
    blurbRisk: "Àwọn nkan wọ̀nyí ń dí àwọn iṣẹ́ tó ní ìgbẹ́kẹ̀lé gíga ní Henry Onyx — ìyọrí láti inú àpamọ́, ìfọwọ́sí olùtà Marketplace, ìjẹ́rìí agbanisíṣẹ́. Yíyanjú wọn ń ṣí ọ̀nà kọ̀ọ̀kan.",
    blurbActive: "Ila kọ̀ọ̀kan ń darí rẹ sí iṣẹ́ tó ń bọ̀ pẹ̀lú àfọwọ́kàn kan. Àwọn àyàn, àmì pàtàkì, àti àwọn ọ̀nà yíyára ó dúró bákan náà ní gbogbo ìpín Henry Onyx.",
  ...
  security: {
    title: "Aabo",
    description: "Ṣayẹwo iṣẹ aabo aipẹ, yi ọrọ igbaniwọle rẹ pada, ki o si pari awọn igba Henry Onyx nigbati o ba nilo.",
    ...
    hero: {
      ...
      statusBlurb: {
        secure: "Kò sí ìṣẹ̀lẹ̀ tó sọ̀rọ̀, ìjẹ́rìí dára, àti gbogbo iṣẹ́ tó ní ìgbẹ́kẹ̀lé gíga ti Henry Onyx ṣí fún ọ.",
    ...
    trustDescription: "Igbẹkẹle n ṣiṣẹ kọja akọọlẹ. O n ṣakoso awọn iṣe iṣowo iye giga, iduro ilana, ati ẹtọ to lagbara kọja awọn modulu Henry Onyx.",
    ...
    whatCurrentStateBody: "Ipo yii pinnu iraye si awọn ṣiṣẹ iye giga ati awọn iṣe iṣowo kọja Henry Onyx.",
    ...
    requirements: {
      ...
      premium: {
        ...
        activity: "Lo awọn ẹka Henry Onyx diẹ sii pẹlu awọn abajade mọ.",
  ...
  activity: {
    title: "Iṣẹ",
    description: "Gbogbo ohun ti o ti ṣe kọja gbogbo awọn ẹka Henry Onyx.",
    emptyTitle: "Ko si iṣẹ kankan sibẹsibẹ",
    emptyDescription:
      "Iṣẹ rẹ kọja awọn ẹka yoo han nibi bi o ṣe nlo awọn iṣẹ Henry Onyx.",
    statusLabels: {
      pending: "Ti n duro",
      open: "Ṣii",
      updated: "Ti tunṣe",
    ...
    filters: {
      ...
      downloadFilename: "Henry Onyx-Itan-Idunadura.pdf",
      shareTitle: "Itan Idunadura Henry Onyx",
      typeLabels: {
        payment: "isanwo",
  ...
  calendar: {
    ...
    heroEyebrow: "Henry Onyx · kàlẹ́ńdà gbogbo ìpín",
  ...
  notifications: {
    metadata: {
      ...
      description: "Gbogbo ìmúdójúìwọ̀n Henry Onyx — àpò owó, àtìlẹyìn, iṣẹ́, ọjà, ìtọ́jú àti púpọ̀ sí i — ní àpótí ìfìtónilétí kan ṣàṣàn.",
    },
    hero: {
      eyebrow: "Henry Onyx · ìfìtónilétí olówó-ìlàyé",
      ariaOverview: "Àkójọpọ̀ ìfìtónilétí",
      ariaVolume: "Ìwọ̀n ìfìtónilétí",
      ariaByDivision: "Nípa ẹ̀ka",
      headlineZero: "Àpótí ìfìtónilétí ófẹ́ ní gbogbo Henry Onyx.",
      ...
      blurbZero: "Ohunkóhun tí Henry Onyx bá fi ránṣẹ́ ń dé síbí ní àkókò gidi — àpò owó, àtìlẹyìn, iṣẹ́, ọjà, ìtọ́jú àti púpọ̀ sí i.",
    ...
    emptyState: {
      ...
      inboxBody: "Iṣẹ́-òyè láti gbogbo Henry Onyx yóò fi ara rẹ̀ hàn níhìn-ín bí ó ṣe ń ṣẹlẹ̀.",
  ...
  invoices: {
    ...
    hero: {
      ...
      blurb:
        "Gbogbo ìsanwó nínú Henry Onyx ń dé sí ibí gẹ́gẹ́ bí PDF tí ó ní àmì-iṣòwò àti tí ó ṣeé gbasilẹ — ìwé Care, àṣẹ Marketplace, owó Studio, ìfijiṣẹ́ Logistics, ìjẹ́rìí Learn.",
    ...
    empty: {
      ...
      description:
        "Awọn iwe-ẹri àti risiti rẹ yóò han níhìn-ín lẹ́yìn tí o bá ṣe ìsanwó nínú àwọn iṣẹ́ Henry Onyx.",
    },
    statuses: {
      paid: "Tí a sanwó",
      pending: "Ní ìdúró",
  ...
  messages: {
    ...
    headlines: {
      zero: "Àpótí ìránṣẹ́ ti ṣofo kárí Henry Onyx.",
  ...
  wallet: {
    hero: {
      ...
      eyebrow: "Àpamọ́wọ́ Henry Onyx · taara",
      availableLabel: "Iwọntunwọnsi tó wà",
      balanceAriaTemplate: "Iwọntunwọnsi tó wà {amount} {currency}",
      settlementFallback: "A ti yanjú ní owó ilẹ̀ rẹ ní oṣuwọn Henry Onyx lójú ọjọ́.",
    ...
    activity: {
      ...
      emptyBody: "Fi owó kún àpamọ́wọ́ rẹ, ìfunni-iṣẹ́ rẹ yóò fi gbogbo gbígba, gbígbé, ìpadàbọ̀ àti ẹ̀bùn hàn níbí ní ọrọ̀ iṣẹ́ Henry Onyx.",
  ...
  support: {
    metadata: {
      title: "Ìrànlọ́wọ́",
      description: "Gba ìrànlọ́wọ́ pẹ̀lú iṣẹ́ Henry Onyx èyíkéyìí.",
    },
    hero: {
      title: "Ìrànlọ́wọ́",
      description: "Gba ìrànlọ́wọ́ pẹ̀lú iṣẹ́ Henry Onyx èyíkéyìí.",
  ...
  payments: {
    ...
    wallet: {
      eyebrow: "Àpamọ́wọ́ Henry Onyx",
      body: "Àpamọ́wọ́ Henry Onyx rẹ wà nígbà gbogbo gẹ́gẹ́ bí àṣàyàn ìsanwó.",
  ...
  savedItems: {
    metadata: {
      ...
      description:
        "Àwọn ohun tí o yà sọ́tọ̀ kúrò nínú apò ọjà Henry Onyx èyíkéyìí, a máa tọ́jú wọn fún ọjọ́ àádọ́rùnún (90) pẹ̀lú ìmọ̀ràn ọ̀sẹ̀ kan ṣáájú parí.",
    },
    hero: {
      title: "Tọ́jú fún àkókò mìíràn",
      description:
        "Àwọn ohun tí o yà sọ́tọ̀ kúrò nínú apò ọjà Henry Onyx èyíkéyìí. A máa tọ́jú wọn fún ọjọ́ àádọ́rùnún (90) tí a ó sì kìlọ̀ fún ọ ní ọ̀sẹ̀ kan kí wọ́n tó parí.",
    },
    summary: {
  ...
  documents: {
    metadata: {
      title: "Àwọn Àkọsílẹ̀",
      description:
        "Àwọn risiisi rẹ, ìjẹ́rìí, àdéhùn àti fáìlì pàtàkì — a fi pamọ́ ní ìkọ̀kọ̀ tí ó sì wà fún ọ ní gbogbo ẹ̀ka Henry Onyx.",
    },
    hero: {
    ...
    empty: {
      ...
      description:
        "Àwọn àkọsílẹ̀ rẹ, risiisi àti ìjẹ́rìí láti ọ̀dọ̀ àwọn ìpèsè Henry Onyx ni a ó tọ́jú síbí.",
    },
    summary: {
    ...
    retention: {
      ...
      body: "A fi àwọn àkọsílẹ̀ pamọ́ pẹ̀lú ààbò, ìwọ nìkan ló lè rí wọn, a ó sì tọ́jú wọn ní gbogbo àkókò tí àkáǹtì Henry Onyx rẹ bá wà, àyàfi tí o bá yọ wọn kúrò.",
    },
  },
  subscriptions: {
    metadata: {
      ...
      description:
        "Àkójọpọ̀ kíkà-nìkan ti àwọn ètò tí ó ń ṣiṣẹ́, tí a kó wá láti àwọn ìpín Henry Onyx.",
    },
    hero: {
  ...
  referrals: {
    metadata: {
      ...
      description:
        "Pe àwọn oníbàárà tí ó dára sí Henry Onyx, kí o sì máa tọpinpin ẹ̀san láti ipo dídúró, sí ìwádìí, sí gbígba.",
    },
    hero: {
      title: "Ìfilọ̀ Ẹnìkejì",
      description:
    ...
    howItWorks: {
      ...
      step1Body:
        "Pín kóòdù tàbí líńkì alaiẹ̀dà rẹ. A o tọpinpin àwọn ọ̀rẹ́ tí ó bẹ̀rù subdomain Henry Onyx èyíkéyìí pẹ̀lú líńkì rẹ lójijì.",
    ...
    policy: {
      eyebrow: "Òfin Ìfilọ̀",
      qualifying:
        "Ìyípadà tí ó dára túmọ̀ sí pé àkáǹtì ẹni tí a fi ránṣẹ́ sí parí iṣẹ́ Henry Onyx tí ó yẹ tí ó gba ìmúdájú ìsanwó àti ìfọkàntán.",
      enforcement:
        "Henry Onyx lè dá, yí padà, tàbí kọsílẹ̀ ẹ̀san fún àwọn ìfilọ̀ ara-ẹni, àyípo ìyípadà àdàkọ, àyípadà tó padà, àpadàbọ̀, tàbí àwọn àpẹẹrẹ ẹ̀san tí ó fún ìfura.",
      separation:
  ...
  divisionProperty: {
    ...
    hero: {
      ...
      tileFoot: {
        savedManagedTemplate: "{count} tí Henry Onyx ń darí",
      ...
      sideBodyMuted:
        "Àwọn ìpolówó tí Henry Onyx ń darí ní àmì Tí ń darí — àtúnyẹ̀wò, àyẹ̀wò, àti ìtẹ̀síwájú àdéhùn ìyálò ni ẹgbẹ́ Property ń ṣe àkójọpọ̀.",
      ...
      state: {
        empty: {
          ...
          blurb:
            "Ṣàwárí àwọn ilé ìyálò, àwọn ìpolówó títà, àti àwọn ilé tí Henry Onyx ń darí. Fipamọ́ àwọn ti ó wù ọ́, gbogbo ìbéèrè, ìbẹ̀wò, tàbí ìtẹ̀síwájú ìpolówó yóò dé níbí lóòòrè.",
        },
        discover: {
    ...
    sections: {
      ...
      savedMetaTemplate: "{saved} tí a fipamọ́ · {managed} tí Henry Onyx ń darí",
    ...
    empty: {
      ...
      savedBody:
        "Ṣàwárí àwọn ilé ìyálò, àwọn ìpolówó títà, àti àwọn ilé tí Henry Onyx ń darí lórí Property. Ohunkóhun tí o bá fipamọ́ yóò dé níbí lóòòrè.",
  ...
  divisionJobs: {
    ...
    hero: {
      ...
      body: "Àwọn ìbéèrè, iṣẹ́ tí a fipamọ́, ìròyìn aṣàrokin, àti ìmúrasílẹ̀ profáìlì ni a ti so mọ́ àkáǹtì Henry Onyx rẹ.",
    ...
    profile: {
      ...
      checklist: {
        ...
        verificationDetail: "Ìgbẹ́kẹ̀lé Jobs ṣì wà ní ààlà títí àkáǹtì Henry Onyx rẹ yóò ti kọjá àyẹ̀wò ìdánimọ̀.",
  ...
  divisionMarketplace: {
    ...
    matters: {
      ...
      application: {
        ...
        bodyDefault: "Ìbéèrè wà ní ìlà àyẹ̀wò Henry Onyx.",
        bodyReviewSuffixTemplate: " · {note}",
        cta: "Wo ipò",
  ...
  divisionLearn: {
    ...
    extras: {
      ...
      teachingTitle: "Kọ́ni pẹ̀lú Henry Onyx",
      statusLabel: "Ipò",
  ...
  divisionStudio: {
    metadata: {
      ...
      description: "Tọpa gbogbo ifowosowopo Studio Henry Onyx ti o so mọ akọọlẹ yii — awọn idamọran, awọn ami iyege, awọn isanwo, awọn ohun ifijiṣẹ, ati iṣẹ ni yara kanna.",
    },
    hero: {
      ...
      sideBody: "Awọn idamọran, awọn ami iyege, awọn ẹri isanwo, awọn ohun ifijiṣẹ, ati awọn ami ibaraẹnisọrọ duro pẹlu idanimọ Henry Onyx kanna ti o n lo nibi gbogbo. Dasibodu ti o wa nisalẹ n ṣe afihan ilọsiwaju gidi ti ẹgbẹ Studio, kii ṣe akojọ ipo.",
      ...
      state: {
        empty: {
          ...
          blurb: "Nigbati idamọran tabi iṣẹ akanṣe ba bẹrẹ pẹlu idanimọ Henry Onyx rẹ, yara Studio ti a muṣiṣẹpọ yoo han nibi — awọn ami iyege, isanwo, awọn ohun ifijiṣẹ, ati igbesẹ atẹle papọ.",
    ...
    empty: {
      ...
      projectsBody: "Ni kete ti a ba ṣẹda idamọran tabi iṣẹ akanṣe pẹlu idanimọ Henry Onyx rẹ, yara Studio ti a muṣiṣẹpọ yoo han nibi — awọn ami iyege, isanwo, awọn ohun ifijiṣẹ, ati igbesẹ atẹle.",
  ...
  divisionLogistics: {
    ...
    hero: {
      ...
      eyebrow: "Henry Onyx Èro̩ ọkọ̀",
      brand: "Henry Onyx Èro̩ ọkọ̀",
  ...
  addresses: {
    ...
    empty: {
      body:
        "O kò tíì fi àdírẹ́sì kankan kún. Fi àkọ́kọ́ rẹ kún kí ìpari rírà yá ní gbogbo Henry Onyx.",
    },
    add: {
      cta: "Fi àdírẹ́sì kún",
  ...
  search: {
    metadata: {
      title: "Wá Akọọlẹ",
      description: "Wá àwọn ọ̀nà iṣẹ́ akọọlẹ Henry Onyx àti àwọn ọ̀nà ìpín tí a so pọ̀.",
    },
    hero: {
      title: "Wá àwọn ọ̀nà iṣẹ́ Henry Onyx rẹ.",
      description:
...
const HA: DeepPartial<AccountCopy> = {
  ...
  overview: {
    ...
    description: "Cibiyar umarni ta Henry Onyx — komai a cikin dukkan sassan, wuri guda.",
    walletBalance: "Ma'auni na Jakar",
    walletHint: "Jakar da aka raba · Yi amfani a duk sabis na Henry Onyx",
    ...
    shareHenryCo: "Raba Henry Onyx da wasu",
    ...
    smartRecommendationsEmpty: "Ci gaba da amfani da sabis na Henry Onyx kuma shawarwari za su daidaita da ayyukanku.",
    smartHomeEmptyFallback:
    ...
    recommendationDescriptions: {
      trustNext: "Buɗe ƙarin ayyuka a cikin Henry Onyx.",
      ...
      fallback: "Ci gaba da amfani da sabis na Henry Onyx kuma shawarwari za su daidaita da ayyukanku.",
    },
  },
  tasks: {
    title: "Ayyuka",
    ...
    blurbRisk: "Wadannan abubuwa suna toshe ayyukan amana mafi girma a Henry Onyx — fitar da kuɗi daga jakar, amincewar mai siyarwa na Marketplace, tabbatar da mai aiki. Warware su yana buɗe kowace hanya.",
    blurbActive: "Kowane layi yana kai ka zuwa aiki na gaba da taɓawa ɗaya. Tace, alamomin fifiko, da hanyoyin haɗi sun kasance daidai a duk sassan Henry Onyx.",
  ...
  security: {
    title: "Tsaro",
    description: "Duba ayyukan tsaro na kwanan nan, canza kalmar sirri, kuma ƙare zaman Henry Onyx idan ya zama dole.",
    ...
    hero: {
      ...
      statusBlurb: {
        secure: "Babu lamuran da ake tuhuma, tabbatarwa tana cikin koshin lafiya, kuma kowane aikin amana mafi girma da Henry Onyx ke bayarwa yana buɗe a gare ka.",
    ...
    trustDescription: "Amana tana aiki a duk asusun. Yanzu tana sarrafa ayyukan kasuwanci masu ƙimar sama, matsayin kulawa, da cancantar ƙarfi a duk modules na Henry Onyx.",
    ...
    whatCurrentStateBody: "Wannan yanayi yana ƙayyade samun damar workflows masu ƙima mai girma da ayyukan kasuwanci a Henry Onyx.",
    ...
    requirements: {
      ...
      premium: {
        ...
        activity: "Yi amfani da ƙarin sassan Henry Onyx tare da sakamakon tsafta.",
  ...
  activity: {
    title: "Aiki",
    description: "Duk abin da kuka yi a sassan Henry Onyx gaba ɗaya.",
    emptyTitle: "Babu aiki tukuna",
    emptyDescription:
      "Aikinku tsakanin sassa zai bayyana a nan yayin da kuke amfani da ayyukan Henry Onyx.",
    statusLabels: {
      pending: "Ana jira",
      open: "A bayyane",
      updated: "An sabunta",
    ...
    filters: {
      ...
      downloadFilename: "Henry Onyx-Tarihin-Mu'amaloli.pdf",
      shareTitle: "Tarihin Mu'amaloli na Henry Onyx",
      typeLabels: {
        payment: "biyan kuɗi",
  ...
  calendar: {
    ...
    heroEyebrow: "Henry Onyx · kalanda na duk rabe-raben",
  ...
  notifications: {
    metadata: {
      title: "Sanarwa",
      description: "Kowane sabunta na Henry Onyx — walat, tallafi, ayyuka, kasuwa, kulawa, da ƙari — a cikin akwatin sako kai tsaye.",
    },
    hero: {
      eyebrow: "Henry Onyx · sanarwa kai tsaye",
      ariaOverview: "Bayyani na sanarwa",
      ariaVolume: "Yawan sanarwa",
      ariaByDivision: "Ta sashe",
      headlineZero: "Akwatin sako babu kome a Henry Onyx.",
      ...
      blurbZero: "Duk abin da Henry Onyx ke aikawa yana isa nan kai tsaye — walat, tallafi, ayyuka, kasuwa, kulawa, da ƙari.",
    ...
    emptyState: {
      ...
      inboxBody: "Ayyuka daga duk faɗin Henry Onyx suna bayyana nan yayin da suke faruwa.",
  ...
  invoices: {
    ...
    hero: {
      ...
      blurb:
        "Kowane biya a cikin Henry Onyx yana zuwa nan a matsayin PDF mai alama mai saukarwa — ajiyar Care, oda na Marketplace, lissafin Studio, jigilar Logistics, takaddun Learn.",
    ...
    empty: {
      ...
      description:
        "Lissafin kuɗin ku da rasidoji za su bayyana nan bayan biyan kuɗi a ayyukan Henry Onyx.",
    },
    statuses: {
      paid: "An biya",
      pending: "Ana jira",
  ...
  messages: {
    ...
    headlines: {
      zero: "Akwatin saƙonni babu kome a duk Henry Onyx.",
  ...
  wallet: {
    hero: {
      ...
      eyebrow: "Walat Henry Onyx · kai tsaye",
      availableLabel: "Ma'aunin da yake samuwa",
      balanceAriaTemplate: "Ma'aunin da yake samuwa {amount} {currency}",
      settlementFallback: "An sasanta shi cikin kuɗin gida a farashin Henry Onyx na yini.",
    ...
    activity: {
      ...
      emptyBody: "Cika walat ɗinka, mai cin abinci na aiki zai nuna a nan kowane kuɗi, cire, mai dawowa da kyauta a duk ayyukan Henry Onyx.",
  ...
  support: {
    metadata: {
      title: "Tallafi",
      description: "Sami taimako don kowane sabis na Henry Onyx.",
    },
    hero: {
      title: "Tallafi",
      description: "Sami taimako don kowane sabis na Henry Onyx.",
  ...
  payments: {
    ...
    wallet: {
      eyebrow: "Walat Henry Onyx",
      body: "Walat Henry Onyx naka koyaushe yana akwai a matsayin zaɓin biya.",
  ...
  savedItems: {
    metadata: {
      ...
      description:
        "Abubuwan da ka ajiye daga kowace kwandon Henry Onyx, ana adana su na kwana 90 tare da gargaɗi mako guda kafin su ƙare.",
    },
    hero: {
      title: "An adana don baya",
      description:
        "Abubuwan da ka ajiye daga kowace kwandon Henry Onyx. Za mu ajiye su na kwana 90 kuma za mu gargaɗe ka mako guda kafin su ƙare.",
    },
    summary: {
  ...
  documents: {
    metadata: {
      title: "Takardu",
      description:
        "Rasit ɗinka, takaddun shaida, kwangiloli da fayilolin muhimmai — ana ajiyewa cikin sirri kuma ana iya samun su a kowace ɓangare ta Henry Onyx.",
    },
    hero: {
    ...
    empty: {
      ...
      description:
        "Takarduka, rasit da takaddun shaida daga sabis ɗin Henry Onyx za a adana su a nan.",
    },
    summary: {
    ...
    retention: {
      ...
      body: "Ana ɓoye takardu yayin da suke ajiye, kai kaɗai za ka iya ganinsu, kuma za mu ajiye su yayin da asusunka na Henry Onyx yake aiki sai dai idan ka cire su.",
    },
  },
  subscriptions: {
    metadata: {
      ...
      description:
        "Taƙaitaccen karatu-kawai na tsare-tsaren da ke aiki, da aka kawo daga sassan Henry Onyx.",
    },
    hero: {
  ...
  referrals: {
    metadata: {
      title: "Tura Wasu",
      description:
        "Gayyaci abokan ciniki masu cancanta zuwa Henry Onyx, kuma ka bi diddigin kyaututtuka ta hanyar dakatarwa, sake nazari, da matakan da aka biya.",
    },
    hero: {
      title: "Tura Wasu",
      description:
    ...
    howItWorks: {
      ...
      step1Body:
        "Raba lambarka ko hanyar haɗinka ta musamman. Ana bi diddigin abokan da ke ziyartar duk wani sashin Henry Onyx ta hanyar haɗinka ta atomatik.",
    ...
    policy: {
      ...
      qualifying:
        "Juyawar da ta cancanta na nufin asusun da aka tura ya kammala aikin Henry Onyx da ya cancanta wanda ya wuce tabbatar da biyan kuɗi da amincewa.",
      enforcement:
        "Henry Onyx na iya riƙewa, mayar da baya, ko soke lada don tura kai, ƙididdigar juyawa biyu, mayar da baya, mayar da kuɗi, ko alamomin lada na zato.",
      separation:
  ...
  divisionProperty: {
    ...
    hero: {
      ...
      tileFoot: {
        savedManagedTemplate: "{count} Henry Onyx na kula da su",
      ...
      sideBodyMuted:
        "Tallace-tallacen da Henry Onyx ke kulawa suna ɗauke da alamar Mai kulawa — bitar, dubawa, da biyo bayan haya na'urar gudanarwar Property ne ke daidaita.",
      ...
      state: {
        empty: {
          ...
          blurb:
            "Gano gidaje don haya, tallace-tallacen sayarwa, da gidajen da Henry Onyx ke kulawa. Ajiye abubuwan da kake so, kuma duk tambaya, ziyara, ko biyo bayan talla zai sauka a nan kai tsaye.",
        },
        discover: {
    ...
    sections: {
      ...
      savedMetaTemplate: "{saved} an ajiye · {managed} Henry Onyx na kula",
    ...
    empty: {
      ...
      savedBody:
        "Gano gidaje don haya, tallace-tallacen sayarwa, da gidajen da Henry Onyx ke kulawa a Property. Duk abin da ka ajiye yana sauka a nan kai tsaye.",
  ...
  divisionJobs: {
    ...
    hero: {
      ...
      body: "Neman ayyuka, ayyukan ajiye, sabuntawa daga masu daukar ma'aikata, da shirye-shiryen bayanin martaba an haɗa su da asusunka na Henry Onyx.",
    ...
    profile: {
      ...
      checklist: {
        ...
        verificationDetail: "Amincewar Jobs ta dakata har sai asusunka na Henry Onyx ya wuce binciken shaidar.",
  ...
  divisionMarketplace: {
    ...
    matters: {
      ...
      application: {
        ...
        bodyDefault: "Aikace-aikace a jerin bita na Henry Onyx.",
        bodyReviewSuffixTemplate: " · {note}",
        cta: "Duba matsayi",
  ...
  divisionLearn: {
    ...
    extras: {
      ...
      teachingTitle: "Koyar da Henry Onyx",
      statusLabel: "Yanayi",
  ...
  divisionStudio: {
    ...
    hero: {
      ...
      sideBody: "Shawarwari, maƙasudai, hujjojin biyan kuɗi, abubuwan da za a kawo, da alamomin sadarwa suna ci gaba da haɗuwa da wannan asalin Henry Onyx da kake amfani da shi a ko’ina. Dashboard ɗin da ke ƙasa yana nuna ainihin ci gaban ƙungiyar Studio, ba jerin matsayi ba.",
      breakdownAriaLabel: "Rabe-raben ayyuka",
      breakdownLabel: "Ta matsayi",
      tiles: {
      ...
      state: {
        empty: {
          ...
          blurb: "Lokacin da shawarwari ko aiki ya fara da asalin Henry Onyx na ka, ɗakin Studio da aka haɗa zai bayyana anan — maƙasudai, biyan kuɗi, abubuwan da za a kawo, da matakin gaba duka.",
    ...
    empty: {
      ...
      projectsBody: "Da zaran an ƙirƙira shawarwari ko aiki da asalin Henry Onyx na ka, ɗakin Studio da aka haɗa zai bayyana anan — maƙasudai, biyan kuɗi, abubuwan da za a kawo, da matakin gaba.",
  ...
  divisionLogistics: {
    ...
    hero: {
      ...
      eyebrow: "Henry Onyx Sufuri",
      brand: "Henry Onyx Sufuri",
  ...
  addresses: {
    ...
    empty: {
      body:
        "Ba ka ƙara wani adireshi ba tukuna. Ƙara naka na farko don saurin biyan kuɗi a duk Henry Onyx.",
    },
    add: {
      cta: "Ƙara adireshi",
  ...
  search: {
    metadata: {
      title: "Bincika Asusu",
      description: "Bincika tafiyar aikin asusun Henry Onyx da hanyoyin sashe da aka haɗa.",
    },
    hero: {
      title: "Bincika tafiyar aikin Henry Onyx ɗinka.",
      description:
...
const ZH: DeepPartial<AccountCopy> = {
  ...
  overview: {
    welcomeBack: "欢迎回来",
    description: "您的 Henry Onyx 指挥中心 — 所有部门的一切，尽在一处。",
    walletBalance: "钱包余额",
    walletHint: "共享钱包 · 可在 Henry Onyx 所有服务中使用",
    notifications: "通知",
    allCaughtUp: "全部已处理",
    unreadMessages: "未读消息",
    ...
    smartRecommendationsEmpty: "继续使用 Henry Onyx 服务，推荐将根据您的活动进行调整。",
    ...
    recommendationDescriptions: {
      trustNext: "解锁 Henry Onyx 中的更多操作。",
      profileNext: "完整的个人资料可提升支持和服务连续性。",
      jobsSaved: "重新查看您已保存的职位并采取行动。",
      fallback: "继续使用 Henry Onyx 服务，推荐将根据您的活动进行调整。",
    },
  },
  tasks: {
    title: "任务",
    ...
    blurbRisk: "这些事项会阻止 Henry Onyx 中更高信任等级的操作 — 钱包提现、Marketplace 卖家审批、雇主验证。清理后即可打通各条通道。",
    blurbActive: "每一行都能让您一键直达下一步操作。筛选器、优先级标签和深链接在所有 Henry Onyx 业务板块中保持一致。",
    metaEmpty: "您已清空。任何新事项到达后会出现在这里。",
    metaCount: "{count} 个未结 · 按优先级和阻塞状态排序。",
  },
  security: {
    title: "安全",
    description: "查看最近的安全活动、更改密码，并在需要时结束 Henry Onyx 会话。",
    heroAriaLabel: "安全概览",
    hero: {
      ...
      statusBlurb: {
        secure: "没有可疑事件，验证状态良好，Henry Onyx 提供的所有高信任操作都对您开放。",
    ...
    trustProfile: "信任档案",
    trustDescription: "信任在整个账户中正常运行。它现在控制更高价值的商业操作、内容审核立场以及在所有 Henry Onyx 模块中更强的资格。",
    trustScore: "账户信任评分",
    signalLabels: {
      emailVerified: "已验证邮箱",
      identityStatus: "身份状态",
    ...
    whatCurrentStateBody: "此状态决定了对 Henry Onyx 中更高价值工作流程和商业操作的访问权限。",
    ...
    requirements: {
      ...
      premium: {
        ...
        activity: "使用更多 Henry Onyx 部门并获得干净的结果。",
  ...
  activity: {
    title: "活动",
    description: "您在所有 Henry Onyx 部门所做的一切。",
    emptyTitle: "暂无活动",
    emptyDescription:
      "当您使用 Henry Onyx 服务时,您跨部门的活动将显示在此处。",
    statusLabels: {
      pending: "待处理",
      open: "未结",
      updated: "已更新",
    ...
    filters: {
      ...
      downloadLabel: "下载对账单",
      downloadFilename: "Henry Onyx-交易历史.pdf",
      shareTitle: "Henry Onyx 交易历史",
      typeLabels: {
        payment: "支付",
        wallet_credit: "钱包入账",
        wallet_debit: "钱包扣款",
  ...
  notifications: {
    metadata: {
      title: "通知",
      description: "Henry Onyx 的每一次更新——钱包、支持、招聘、市场、护理及更多——尽在一个实时收件箱中。",
    },
    hero: {
      eyebrow: "Henry Onyx · 实时通知",
      ariaOverview: "通知概览",
      ariaVolume: "通知数量",
      ariaByDivision: "按部门",
      headlineZero: "Henry Onyx 收件箱已清零。",
      headlineOne: "有一件事需要您的关注。",
      headlineFew: "{count} 条通知待处理。",
      headlineMany: "您的各部门有 {count} 条更新。",
      blurbZero: "Henry Onyx 发送的任何内容都会实时到达此处——钱包、支持、招聘、市场、护理及更多。",
    ...
    emptyState: {
      inboxTitle: "全部处理完毕。",
      inboxBody: "整个 Henry Onyx 的活动将在发生时显示在此处。",
      filterTitle: "此视图中无活动。",
  ...
  invoices: {
    ...
    hero: {
      ...
      blurb:
        "Henry Onyx 中的每一笔付款都会以带品牌、可下载的 PDF 形式到达此处 — Care 预订、Marketplace 订单、Studio 发票、Logistics 货运、Learn 证书。",
    ...
    empty: {
      title: "暂无发票",
      description: "您在 Henry Onyx 服务中完成付款后，发票和收据将出现在此。",
    },
    statuses: {
      paid: "已支付",
      pending: "待处理",
  ...
  wallet: {
    hero: {
      ariaLabel: "钱包余额",
      eyebrow: "Henry Onyx 钱包 · 实时",
      availableLabel: "可用余额",
      balanceAriaTemplate: "可用余额 {amount} {currency}",
      settlementFallback: "按当日 Henry Onyx 汇率结算为您的本地货币。",
    ...
    activity: {
      ariaLabel: "钱包交易",
      emptyTitle: "暂无交易",
      emptyBody: "为钱包充值后,您的活动流将在此显示 Henry Onyx 各项服务的每笔入账、出账、退款和奖励。",
      fallbackTitle: "钱包交易",
    },
    funding: {
      proofUploaded: "付款已确认",
  ...
  support: {
    metadata: {
      title: "支持",
      description: "获取任何 Henry Onyx 服务的帮助。",
    },
    hero: {
      title: "支持",
      description: "获取任何 Henry Onyx 服务的帮助。",
  ...
  payments: {
    ...
    wallet: {
      eyebrow: "Henry Onyx 钱包",
      body: "您的 Henry Onyx 钱包始终可作为支付选项使用。",
      manageCta: "管理钱包",
    },
  },
  savedItems: {
    metadata: {
      title: "稍后保存",
      description: "您从任何 Henry Onyx 购物车中暂存的商品,我们会为您保留 90 天,并在到期前一周提醒。",
    },
    hero: {
      title: "稍后保存",
      description: "您从任何 Henry Onyx 购物车中暂存的商品。我们会为您保留 90 天,并在到期前一周提醒您。",
    },
    summary: {
  ...
  documents: {
    metadata: {
      title: "文档",
      description: "您的收据、证书、合同和重要文件——私密保存,可在所有 Henry Onyx 板块中访问。",
    },
    hero: {
      eyebrow: "个人保险库",
      title: "文档",
    ...
    empty: {
      title: "暂无文档",
      description: "来自 Henry Onyx 服务的文档、收据和证书将保存在此处。",
    },
    summary: {
    ...
    retention: {
      eyebrow: "隐私与保留",
      title: "您的文件保持私密",
      body: "文档在静态时加密,仅您可见,且在 Henry Onyx 账户存续期间一直保留,除非您将其删除。",
    },
  },
  subscriptions: {
    metadata: {
      title: "订阅",
      description:
        "来自各 Henry Onyx 部门、已同步至共享账户中心的活动订阅的只读摘要。",
    },
    hero: {
      eyebrow: "活动订阅",
      title: "订阅",
  ...
  referrals: {
    metadata: {
      title: "推荐",
      description: "邀请符合条件的客户加入 Henry Onyx,并跟踪奖励从待处理、审核到记入帐户的全过程。",
    },
    hero: {
      title: "推荐",
      description: "邀请符合条件的客户加入 Henry Onyx,并跟踪奖励从待处理、审核到记入帐户的全过程。",
    ...
    howItWorks: {
      eyebrow: "工作原理",
      step1Title: "分享您的代码",
      step1Body: "分享您的独特代码或链接。通过您的链接访问任何 Henry Onyx 子域名的朋友都将被自动追踪。",
      step2Title: "他们进行交易",
      step2Body:
    ...
    policy: {
      eyebrow: "推荐政策",
      qualifying: "合格转化指被推荐帐户完成了通过支付和信任验证的合格 Henry Onyx 操作。",
      enforcement:
        "对于自我推荐、重复转化循环、退单、退款或可疑奖励模式,Henry Onyx 可保留、撤销或取消奖励。",
  ...
  divisionProperty: {
    ...
    hero: {
      ...
      tileFoot: {
        savedManagedTemplate: "{count} 套由 Henry Onyx 托管",
      ...
      sideBodyMuted:
        "Henry Onyx 托管的房源带有“托管”标识 — 审核、勘察与租约跟进均由 Property 团队协调。",
      ...
      state: {
        empty: {
          ...
          blurb:
            "发现住宅租赁、出售房源以及由 Henry Onyx 托管的住宅。收藏您的喜爱,每一项询盘、看房或房源跟进都会自动同步到这里。",
        },
        discover: {
    ...
    sections: {
      ...
      savedMetaTemplate: "已收藏 {saved} 套 · 其中 {managed} 套由 Henry Onyx 托管",
      activity: "近期活动",
    ...
    empty: {
      savedTitle: "尚未收藏任何房源",
      savedBody:
        "在 Property 发现住宅租赁、出售房源以及由 Henry Onyx 托管的住宅。您收藏的内容会自动同步到这里。",
  ...
  divisionJobs: {
    ...
    hero: {
      ...
      body: "申请、收藏职位、招聘方动态和个人资料准备度均已关联到您的 Henry Onyx 账户。",
    ...
    profile: {
      ...
      checklist: {
        ...
        verificationDetail: "在 Henry Onyx 账户完成身份审核前,Jobs 信任度保持封顶。",
        proofLabel: "工作证明",
  ...
  divisionMarketplace: {
    ...
    matters: {
      ...
      application: {
        ...
        bodyDefault: "申请正在 Henry Onyx 审核队列中。",
        bodyReviewSuffixTemplate: " · {note}",
        cta: "查看状态",
        defaultStatus: "已提交",
      },
  ...
  divisionStudio: {
    ...
    hero: {
      ...
      sideBody: "提案、里程碑、付款凭证、交付物和沟通信号都与你在各处使用的同一个 Henry Onyx 身份相连。下方仪表盘反映 Studio 团队的实际进展,而不是一份状态清单。",
      ...
      state: {
        empty: {
          ...
          blurb: "当一个提案或项目以你的 Henry Onyx 身份上线时,同步的 Studio 房间会出现在这里 — 里程碑、付款、交付物和下一步行动汇于一处。",
          ctaPrimary: "启动简报",
    ...
    empty: {
      ...
      projectsBody: "一旦以你的 Henry Onyx 身份创建提案或项目,同步的 Studio 房间就会出现在这里 — 里程碑、付款、交付物和下一步行动。",
  ...
  addresses: {
    ...
    empty: {
      body: "您还未添加任何地址。添加第一个地址，在 Henry Onyx 各处更快完成结算。",
    },
    add: {
      cta: "添加地址",
      formTitle: "添加新地址",
  ...
  search: {
    metadata: {
      title: "搜索账户",
      description: "搜索 Henry Onyx 账户工作流程以及关联的业务板块路径。",
    },
    hero: {
      title: "搜索您的 Henry Onyx 工作流程。",
...
const HI: DeepPartial<AccountCopy> = {
  ...
  overview: {
    ...
    description: "आपका Henry Onyx कमांड सेंटर — सभी डिवीजनों में सब कुछ, एक जगह।",
    walletBalance: "वॉलेट शेष",
    walletHint: "साझा वॉलेट · Henry Onyx सेवाओं में उपयोग करें",
    ...
    shareHenryCo: "Henry Onyx को दूसरों के साथ साझा करें",
    transactions: "लेनदेन",
    ...
    smartRecommendationsEmpty: "Henry Onyx सेवाओं का उपयोग करते रहें और अनुशंसाएं आपकी गतिविधि के अनुसार अनुकूलित होंगी।",
    smartHomeEmptyFallback:
    ...
    recommendationDescriptions: {
      trustNext: "Henry Onyx में अधिक क्रियाएं अनलॉक करें।",
      ...
      fallback: "Henry Onyx सेवाओं का उपयोग करते रहें और अनुशंसाएं आपकी गतिविधि के अनुसार अनुकूलित होंगी।",
    },
  },
  tasks: {
    title: "कार्य",
    ...
    blurbRisk: "ये आइटम Henry Onyx में उच्च-विश्वास क्रियाओं को रोकते हैं — वॉलेट निकासी, Marketplace विक्रेता अनुमोदन, नियोक्ता सत्यापन। इन्हें हटाने पर हर लेन खुल जाती है।",
    blurbActive: "हर पंक्ति आपको एक टैप में अगली क्रिया तक ले जाती है। फ़िल्टर, प्राथमिकता चिप्स और डीपलिंक हर Henry Onyx विभाग में एक जैसे रहते हैं।",
    metaEmpty: "आप साफ हैं। कोई नई चीज आते ही यहाँ दिखेगी।",
    metaCount: "{count} खुले · प्राथमिकता और ब्लॉकिंग स्थिति के अनुसार क्रमबद्ध।",
  },
  security: {
    title: "सुरक्षा",
    description: "हाल की सुरक्षा गतिविधि की समीक्षा करें, अपना पासवर्ड बदलें, और जरूरत होने पर Henry Onyx सत्र समाप्त करें।",
    ...
    hero: {
      ...
      statusBlurb: {
        secure: "कोई संदिग्ध घटना नहीं, सत्यापन स्वस्थ है, और Henry Onyx की हर उच्च-विश्वास क्रिया आपके लिए खुली है।",
    ...
    trustDescription: "विश्वास पूरे खाते में चालू है। यह अब उच्च-मूल्य व्यावसायिक क्रियाओं, मॉडरेशन स्थिति और Henry Onyx मॉड्यूल में मजबूत पात्रता को नियंत्रित करता है।",
    ...
    whatCurrentStateBody: "यह स्थिति Henry Onyx में उच्च-मूल्य वर्कफ़्लो और व्यावसायिक क्रियाओं तक पहुंच निर्धारित करती है।",
    ...
    requirements: {
      ...
      premium: {
        ...
        activity: "स्वच्छ परिणामों के साथ अधिक Henry Onyx डिवीजनों का उपयोग करें।",
  ...
  activity: {
    title: "गतिविधि",
    description: "Henry Onyx के सभी डिवीजनों में आपने जो कुछ भी किया है।",
    emptyTitle: "अभी तक कोई गतिविधि नहीं",
    emptyDescription:
      "जैसे ही आप Henry Onyx सेवाओं का उपयोग करेंगे, आपकी क्रॉस-डिवीजन गतिविधि यहाँ दिखाई देगी।",
    statusLabels: {
      pending: "लंबित",
      open: "खुला",
      updated: "अद्यतन",
    ...
    filters: {
      ...
      downloadFilename: "Henry Onyx-लेन-देन-इतिहास.pdf",
      shareTitle: "Henry Onyx लेन-देन इतिहास",
      typeLabels: {
        payment: "भुगतान",
  ...
  calendar: {
    ...
    heroEyebrow: "Henry Onyx · क्रॉस-पोर्टल कैलेंडर",
  ...
  notifications: {
    metadata: {
      title: "सूचनाएँ",
      description: "Henry Onyx का हर अपडेट — वॉलेट, सहायता, नौकरियाँ, मार्केटप्लेस, केयर और अधिक — एक लाइव इनबॉक्स में।",
    },
    hero: {
      eyebrow: "Henry Onyx · लाइव सूचनाएँ",
      ariaOverview: "सूचनाओं का अवलोकन",
      ariaVolume: "सूचनाओं की मात्रा",
      ariaByDivision: "विभाग के अनुसार",
      headlineZero: "Henry Onyx में इनबॉक्स ज़ीरो।",
      headlineOne: "एक बात आपका ध्यान चाहती है।",
      headlineFew: "{count} सूचनाएँ निपटाने के लिए।",
      headlineMany: "आपके विभागों में {count} अपडेट।",
      blurbZero: "Henry Onyx जो कुछ भी भेजता है वह यहाँ रीयल-टाइम में आता है — वॉलेट, सहायता, नौकरियाँ, मार्केटप्लेस, केयर और अधिक।",
    ...
    emptyState: {
      ...
      inboxBody: "Henry Onyx की गतिविधि यहाँ रीयल-टाइम में दिखेगी।",
  ...
  invoices: {
    ...
    hero: {
      ...
      blurb:
        "Henry Onyx में हर भुगतान यहाँ ब्रांडेड, डाउनलोड करने योग्य PDF के रूप में पहुँचता है — Care बुकिंग, Marketplace ऑर्डर, Studio चालान, Logistics शिपमेंट, Learn प्रमाणपत्र।",
    ...
    empty: {
      ...
      description:
        "Henry Onyx सेवाओं में भुगतान करने के बाद आपके चालान और रसीदें यहाँ दिखेंगी।",
    },
    statuses: {
      paid: "भुगतान हुआ",
      pending: "लंबित",
  ...
  messages: {
    ...
    headlines: {
      zero: "पूरे Henry Onyx में इनबॉक्स खाली है।",
  ...
  wallet: {
    hero: {
      ariaLabel: "वॉलेट शेष",
      eyebrow: "Henry Onyx वॉलेट · लाइव",
      availableLabel: "उपलब्ध शेष",
      balanceAriaTemplate: "उपलब्ध शेष {amount} {currency}",
      settlementFallback: "उस दिन की Henry Onyx दर पर आपकी स्थानीय मुद्रा में निपटाया गया।",
    ...
    activity: {
      ...
      emptyBody: "अपने वॉलेट में राशि जोड़ें, और आपकी गतिविधि फ़ीड यहाँ Henry Onyx सेवाओं में हर क्रेडिट, डेबिट, रिफ़ंड और बोनस के साथ भर जाएगी।",
  ...
  support: {
    metadata: {
      title: "सहायता",
      description: "किसी भी Henry Onyx सेवा के लिए सहायता प्राप्त करें।",
    },
    hero: {
      title: "सहायता",
      description: "किसी भी Henry Onyx सेवा के लिए सहायता प्राप्त करें।",
  ...
  payments: {
    ...
    wallet: {
      eyebrow: "Henry Onyx वॉलेट",
      body: "आपका Henry Onyx वॉलेट हमेशा भुगतान विकल्प के रूप में उपलब्ध है।",
  ...
  savedItems: {
    metadata: {
      ...
      description:
        "जो वस्तुएँ आपने किसी भी Henry Onyx कार्ट से अलग रखी हैं — हम उन्हें 90 दिन तक रखते हैं और समाप्ति से एक सप्ताह पहले सूचित करते हैं।",
    },
    hero: {
      title: "बाद के लिए सहेजें",
      description:
        "जो वस्तुएँ आपने किसी भी Henry Onyx कार्ट से अलग रखी हैं। हम उन्हें 90 दिन तक रखेंगे और समाप्ति से एक सप्ताह पहले आपको चेताएँगे।",
    },
    summary: {
  ...
  documents: {
    metadata: {
      title: "दस्तावेज़",
      description:
        "आपकी रसीदें, प्रमाणपत्र, अनुबंध और महत्वपूर्ण फ़ाइलें — निजी रूप से सुरक्षित और हर Henry Onyx डिवीज़न में उपलब्ध।",
    },
    hero: {
    ...
    empty: {
      ...
      description:
        "Henry Onyx सेवाओं के आपके दस्तावेज़, रसीदें और प्रमाणपत्र यहाँ संग्रहीत होंगे।",
    },
    summary: {
    ...
    retention: {
      ...
      body: "दस्तावेज़ विश्राम में एन्क्रिप्ट किए जाते हैं, केवल आपको दिखाई देते हैं और जब तक आप उन्हें न हटाएँ, आपके Henry Onyx खाते के पूरे जीवनकाल तक संग्रहीत रहते हैं।",
    },
  },
  subscriptions: {
    metadata: {
      title: "सदस्यताएँ",
      description:
        "साझा खाता हब में सिंक की गई सक्रिय योजनाओं का केवल-पठन सारांश, Henry Onyx की विभिन्न डिवीज़न से।",
    },
    hero: {
  ...
  referrals: {
    metadata: {
      title: "रेफरल",
      description:
        "Henry Onyx में योग्य ग्राहकों को आमंत्रित करें और लंबित, समीक्षाधीन, और जमा की गई स्थितियों के माध्यम से पुरस्कारों को ट्रैक करें।",
    },
    hero: {
      title: "रेफरल",
      description:
    ...
    howItWorks: {
      ...
      step1Body:
        "अपना विशिष्ट कोड या लिंक साझा करें। आपके लिंक के साथ किसी भी Henry Onyx सबडोमेन पर जाने वाले मित्र स्वचालित रूप से ट्रैक हो जाते हैं।",
    ...
    policy: {
      eyebrow: "रेफरल नीति",
      qualifying:
        "एक योग्यता रूपांतरण का अर्थ है कि रेफर किए गए खाते ने एक योग्य Henry Onyx कार्रवाई पूरी की जो भुगतान और विश्वास सत्यापन में उत्तीर्ण हुई।",
      enforcement:
        "Henry Onyx स्व-रेफरल, डुप्लिकेट रूपांतरण लूप, उलट, धनवापसी, या संदिग्ध पुरस्कार पैटर्न के लिए पुरस्कार रोक सकता है, उलट सकता है, या रद्द कर सकता है।",
      separation:
  ...
  divisionProperty: {
    ...
    hero: {
      ...
      tileFoot: {
        savedManagedTemplate: "{count} Henry Onyx द्वारा प्रबंधित",
      ...
      sideBodyMuted:
        "Henry Onyx द्वारा प्रबंधित लिस्टिंग पर “प्रबंधित” बैज दिखता है — समीक्षा, निरीक्षण और लीज फॉलो-अप का समन्वय Property टीम करती है।",
      ...
      state: {
        empty: {
          ...
          blurb:
            "आवासीय किराये, बिक्री लिस्टिंग और Henry Onyx-प्रबंधित घर खोजें। अपने पसंदीदा सहेजें, और हर पूछताछ, अवलोकन या लिस्टिंग फॉलो-अप यहाँ स्वतः आ जाता है।",
        },
        discover: {
    ...
    sections: {
      ...
      savedMetaTemplate: "{saved} सहेजे · {managed} Henry Onyx द्वारा प्रबंधित",
      activity: "हाल की गतिविधि",
    ...
    empty: {
      ...
      savedBody:
        "Property पर आवासीय किराये, बिक्री लिस्टिंग और Henry Onyx-प्रबंधित घर खोजें। जो भी आप सहेजेंगे वह यहाँ स्वतः आ जाएगा।",
  ...
  divisionJobs: {
    ...
    hero: {
      ...
      body: "आवेदन, सहेजी भूमिकाएँ, भर्तीकर्ता अपडेट और प्रोफ़ाइल तत्परता आपके Henry Onyx खाते से जुड़े हैं।",
    ...
    profile: {
      ...
      checklist: {
        ...
        verificationDetail: "जब तक आपका Henry Onyx खाता पहचान समीक्षा पास नहीं करता, जॉब्स विश्वास सीमित रहेगा।",
  ...
  divisionMarketplace: {
    ...
    matters: {
      ...
      application: {
        ...
        bodyDefault: "आवेदन Henry Onyx समीक्षा कतार में है।",
        bodyReviewSuffixTemplate: " · {note}",
        cta: "स्थिति देखें",
  ...
  divisionLearn: {
    ...
    extras: {
      ...
      teachingTitle: "Henry Onyx के साथ पढ़ाएँ",
      statusLabel: "स्थिति",
  ...
  divisionStudio: {
    ...
    hero: {
      ...
      sideBody: "प्रस्ताव, माइलस्टोन, भुगतान प्रमाण, डिलिवरेबल और संवाद संकेत उसी Henry Onyx पहचान से जुड़े रहते हैं जिसका उपयोग आप हर जगह करते हैं। नीचे का डैशबोर्ड Studio टीम की वास्तविक प्रगति दिखाता है, स्थिति सूची नहीं।",
      breakdownAriaLabel: "गतिविधि विभाजन",
      breakdownLabel: "स्थिति अनुसार",
      tiles: {
      ...
      state: {
        empty: {
          ...
          blurb: "जब आपकी Henry Onyx पहचान के साथ कोई प्रस्ताव या प्रोजेक्ट सक्रिय होगा, सिंक की हुई Studio कक्ष यहाँ दिखेगी — माइलस्टोन, भुगतान, डिलिवरेबल और अगला कदम एक साथ।",
    ...
    empty: {
      ...
      projectsBody: "जैसे ही आपकी Henry Onyx पहचान के साथ प्रस्ताव या प्रोजेक्ट बनेगा, सिंक की हुई Studio कक्ष यहाँ दिखेगी — माइलस्टोन, भुगतान, डिलिवरेबल और अगला कदम।",
  ...
  divisionLogistics: {
    ...
    hero: {
      ...
      eyebrow: "Henry Onyx लॉजिस्टिक्स",
      brand: "Henry Onyx लॉजिस्टिक्स",
  ...
  addresses: {
    ...
    empty: {
      body:
        "आपने अभी तक कोई पता नहीं जोड़ा है। Henry Onyx में तेज़ चेकआउट के लिए अपना पहला पता जोड़ें।",
    },
    add: {
      cta: "पता जोड़ें",
  ...
  search: {
    metadata: {
      title: "खाता खोजें",
      description: "Henry Onyx खाता वर्कफ़्लो और जुड़े विभाग मार्ग खोजें।",
    },
    hero: {
      title: "अपने Henry Onyx वर्कफ़्लो खोजें।",
      description:
