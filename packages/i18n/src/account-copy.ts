...
const EN: AccountCopy = {
  ...
  wallet: {
    ...
    pendingOps: {
      ...
      fundingDescSingular: "{count} request sitting in live rail review — reference matching keeps the queue moving.",
      fundingDescPlural: "{count} requests sitting in live rail review — reference matching keeps the queue moving.",
    ...
    funding: {
      proofUploaded: "Reference matched",
...
const FR: DeepPartial<AccountCopy> = {
  ...
  wallet: {
    ...
    pendingOps: {
      ...
      fundingDescSingular: "{count} demande en examen du rail — le rapprochement de référence fait avancer la file.",
      fundingDescPlural: "{count} demandes en examen du rail — le rapprochement de référence fait avancer la file.",
    ...
    funding: {
      proofUploaded: "Référence rapprochée",
      awaitingProof: "En traitement",
      ariaLabelTemplate: "Demande d’approvisionnement {reference} de ₦{amount}",
    },
    statusLabels: {
      pending: "En attente d’examen",
      awaiting_proof: "En traitement",
...
const DE: DeepPartial<AccountCopy> = {
  ...
  wallet: {
    ...
    pendingOps: {
      ...
      fundingDescSingular: "{count} Anfrage im Rail-Abgleich — Referenzabgleich hält die Warteschlange in Bewegung.",
      fundingDescPlural: "{count} Anfragen im Rail-Abgleich — Referenzabgleich hält die Warteschlange in Bewegung.",
    ...
    funding: {
      proofUploaded: "Referenz abgeglichen",
      awaitingProof: "In Bearbeitung",
      ariaLabelTemplate: "Einzahlungsanfrage {reference} über ₦{amount}",
    },
    statusLabels: {
      pending: "Wartet auf Prüfung",
      awaiting_proof: "In Bearbeitung",
...
const IT: DeepPartial<AccountCopy> = {
  ...
  wallet: {
    ...
    pendingOps: {
      ...
      fundingDescSingular: "{count} richiesta in revisione rail — l'abbinamento del riferimento fa avanzare la coda.",
      fundingDescPlural: "{count} richieste in revisione rail — l'abbinamento del riferimento fa avanzare la coda.",
    ...
    funding: {
      proofUploaded: "Riferimento abbinato",
...
const IG: DeepPartial<AccountCopy> = {
  ...
  wallet: {
    ...
    pendingOps: {
      ...
      fundingDescSingular: "{count} request is in live rail review — reference matching keeps the queue moving.",
      fundingDescPlural: "{count} requests are in live rail review — reference matching keeps the queue moving.",
...
const ZH: DeepPartial<AccountCopy> = {
  ...
  wallet: {
    ...
    pendingOps: {
      ...
      fundingDescSingular: "{count} 项申请正在支付通道审核中——参考号匹配会推动队列前进。",
      fundingDescPlural: "{count} 项申请正在支付通道审核中——参考号匹配会推动队列前进。",
      fundingCta: "打开充值通道",
