...
const EN: EcosystemConsentCopy = {
  banner: {
    ...
    title: "Choose how Henry Onyx stores settings on this device.",
  ...
  panel: {
    ...
    personalized: {
      ...
      description:
        "Allows tailored recommendations and contextual hints based on how you use Henry Onyx properties.",
    },
    analytics: {
      title: "Analytics",
  ...
  language: {
    label: "Language",
    hint: "Applies across Henry Onyx sites that support your selection.",
  },
};
...
const FR: Partial<EcosystemConsentCopy> = {
  banner: {
    ...
    title: "Choisissez comment Henry Onyx enregistre les réglages sur cet appareil.",
  ...
  panel: {
    ...
    personalized: {
      ...
      description:
        "Permet recommandations et repères contextuels selon votre usage des sites Henry Onyx",
    },
    analytics: {
      title: "Analytique",
  ...
  language: {
    label: "Langue",
    hint: "S’applique aux sites Henry Onyx qui prennent en charge votre choix.",
  },
};
...
const IG: Partial<EcosystemConsentCopy> = {
  banner: {
    ...
    title: "Họrọ otu Henry Onyx si echekwa ntọala na ngwaọrụ a.",
  ...
  panel: {
    ...
    personalized: { title: "Ahụmịhe ahaziri", description: "Na-enye ohere ndụmọdụ dabara adaba dabere n'otu ị si eji saịtị Henry Onyx." },
  ...
  language: { label: "Asụsụ", hint: "Na-emetụta saịtị Henry Onyx niile nke na-akwado nhọrọ gị." },
};

const AR: Partial<EcosystemConsentCopy> = {
  banner: {
    eyebrow: "تفضيلات التجربة",
    title: "اختر كيف تحفظ Henry Onyx الإعدادات على هذا الجهاز.",
  ...
  panel: {
    ...
    personalized: { title: "تجربة مخصصة", description: "يسمح بتوصيات مخصصة بناءً على استخدامك لمواقع Henry Onyx" },
  ...
  language: { label: "اللغة", hint: "ينطبق على مواقع Henry Onyx التي تدعم اختيارك." },
};

const ES: Partial<EcosystemConsentCopy> = {
  banner: {
    eyebrow: "Preferencias de experiencia",
    title: "Elige cómo Henry Onyx guarda configuraciones en este dispositivo.",
  ...
  panel: {
    ...
    personalized: { title: "Experiencia personalizada", description: "Permite recomendaciones personalizadas según tu uso de los sitios de Henry Onyx" },
  ...
  language: { label: "Idioma", hint: "Se aplica en los sitios de Henry Onyx que admiten tu selección." },
};

const PT: Partial<EcosystemConsentCopy> = {
  banner: {
    eyebrow: "Preferências de experiência",
    title: "Escolha como a Henry Onyx armazena configurações neste dispositivo.",
  ...
  panel: {
    ...
    personalized: { title: "Experiência personalizada", description: "Permite recomendações personalizadas com base no seu uso dos sites da Henry Onyx" },
  ...
  language: { label: "Idioma", hint: "Aplica-se nos sites da Henry Onyx que suportam sua seleção." },
};

const YO: Partial<EcosystemConsentCopy> = {
  banner: {
    eyebrow: "Àwọn àṣàyàn ìrírí",
    title: "Yan bí Henry Onyx ṣe tọ́jú àwọn ètò lórí ẹ̀rọ yìí.",
  ...
  panel: {
    ...
    personalized: { title: "Ìrírí àdáni", description: "Fún àwọn ìmọ̀ràn tó bá irú bí o ṣe ń lo àwọn ojú-òpó Henry Onyx mu." },
  ...
  language: { label: "Èdè", hint: "Ń ṣiṣẹ́ lórí àwọn ojú-òpó Henry Onyx tó ń gbà àṣàyàn rẹ." },
};

const HA: Partial<EcosystemConsentCopy> = {
  banner: {
    eyebrow: "Zaɓuɓɓukan ƙwarewa",
    title: "Zaɓi yadda Henry Onyx ke ajiye saiti a wannan na'ura.",
  ...
  panel: {
    ...
    personalized: { title: "Ƙwarewa ta musamman", description: "Yana ba da damar shawarwarin da suka dace bisa yadda kake amfani da shafukan Henry Onyx." },
  ...
  language: { label: "Yare", hint: "Ana amfani da shi a shafukan Henry Onyx waɗanda ke goyan bayan zaɓinka." },
};
...
const DE: Partial<EcosystemConsentCopy> = {
  banner: {
    ...
    title: "Wählen Sie, wie Henry Onyx Einstellungen auf diesem Gerät speichert.",
  ...
  panel: {
    ...
    personalized: { title: "Personalisiertes Erlebnis", description: "Ermöglicht maßgeschneiderte Empfehlungen basierend auf Ihrer Nutzung der Henry Onyx Seiten." },
  ...
  language: { label: "Sprache", hint: "Gilt für Henry Onyx Seiten, die Ihre Auswahl unterstützen." },
};

const ZH: Partial<EcosystemConsentCopy> = {
  banner: {
    eyebrow: "体验偏好",
    title: "选择 Henry Onyx 如何在此设备上存储设置。",
  ...
  panel: {
    ...
    personalized: { title: "个性化体验", description: "根据您使用 Henry Onyx 网站的方式提供量身定制的推荐。" },
  ...
  language: { label: "语言", hint: "适用于支持您所选语言的 Henry Onyx 网站。" },
};

const HI: Partial<EcosystemConsentCopy> = {
  banner: {
    eyebrow: "अनुभव प्राथमिकताएं",
    title: "चुनें कि Henry Onyx इस डिवाइस पर सेटिंग्स कैसे संग्रहीत करे।",
  ...
  panel: {
    ...
    personalized: { title: "वैयक्तिकृत अनुभव", description: "Henry Onyx साइटों के उपयोग के आधार पर अनुकूलित सिफारिशों की अनुमति देता है।" },
  ...
  language: { label: "भाषा", hint: "Henry Onyx साइटों पर लागू होता है जो आपके चयन का समर्थन करती हैं।" },
};

const IT: Partial<EcosystemConsentCopy> = {
  "banner": {
    "eyebrow": "Preferenze dell'esperienza",
    "title": "Scegli come Henry Onyx memorizza le impostazioni su questo dispositivo.",
  ...
  "panel": {
    ...
    "personalized": {
      ...
      "description": "Consente consigli personalizzati e suggerimenti contestuali in base al modo in cui utilizzi le proprietà Henry Onyx"
    },
    "analytics": {
      "title": "Analitica",
  ...
  "language": {
    "label": "Lingua",
    "hint": "Si applica a tutti i siti Henry Onyx che supportano la tua selezione."
  }
};
