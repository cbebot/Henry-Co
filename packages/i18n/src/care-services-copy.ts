...
const CARE_SERVICES_COPY_FR: DeepPartial<CareServicesCopy> = {
  metadata: {
    titleTemplate: "Services | {division}",
    description:
      "Découvrez l’entretien textile, le nettoyage à domicile, le nettoyage de bureaux, l’enlèvement, la livraison et les prestations récurrentes de HenryCo Care.",
  },
  hero: {
...
const CARE_SERVICES_COPY_ES: DeepPartial<CareServicesCopy> = {
  metadata: {
    ...
    description:
      "Descubra el cuidado de prendas, la limpieza del hogar, la limpieza de oficinas, la recogida, la entrega y los servicios recurrentes de HenryCo Care.",
  },
  hero: {
...
const CARE_SERVICES_COPY_PT: DeepPartial<CareServicesCopy> = {
  metadata: {
    ...
    description:
      "Conheça os cuidados com vestuário, a limpeza residencial, a limpeza de escritórios, a recolha, a entrega e os serviços recorrentes da HenryCo Care.",
  },
  hero: {
...
const CARE_SERVICES_COPY_AR: DeepPartial<CareServicesCopy> = {
  metadata: {
    ...
    description:
      "اكتشف خدمات العناية بالملابس، وتنظيف المنازل والمكاتب، والاستلام والتوصيل، والخدمات المتكررة من HenryCo Care.",
  },
  hero: {
...
const CARE_SERVICES_COPY_DE: DeepPartial<CareServicesCopy> = {
  metadata: {
    ...
    description:
      "Entdecken Sie Kleiderpflege, Wohnungs- und Büroreinigung, Abholung, Lieferung sowie wiederkehrende Leistungen von HenryCo Care.",
  },
  hero: {
...
const CARE_SERVICES_COPY_IT: DeepPartial<CareServicesCopy> = {
  metadata: {
    ...
    description:
      "Scopri la cura del guardaroba, la pulizia di case e uffici, il ritiro, la consegna e i servizi ricorrenti di HenryCo Care.",
  },
  hero: {
...
const CARE_SERVICES_COPY_ZH: DeepPartial<CareServicesCopy> = {
  metadata: {
    ...
    description:
      "了解 HenryCo Care 的衣物护理、家庭保洁、办公室保洁、取送以及周期性服务。",
  },
  hero: {
    eyebrow: "服务体系",
...
const CARE_SERVICES_COPY_HI: DeepPartial<CareServicesCopy> = {
  metadata: {
    ...
    description:
      "HenryCo Care की वस्त्र देखभाल, घरेलू सफाई, कार्यालय सफाई, पिकअप, डिलीवरी और नियमित सेवाओं को जानिए।",
  },
  hero: {
    eyebrow: "सेवा संग्रह",
...
const CARE_SERVICES_COPY_IG: DeepPartial<CareServicesCopy> = {
  metadata: {
    ...
    description:
      "Mata banyere nlekọta uwe, nhicha ụlọ, nhicha ọfịs, mbu na nbuga, na ọrụ ndị na-aga n’ihu nke HenryCo Care.",
  },
  hero: {
...
const CARE_SERVICES_COPY_YO: DeepPartial<CareServicesCopy> = {
  metadata: {
    ...
    description:
      "Wo ìtọ́jú aṣọ, ìmọ́tótó ilé, ìmọ́tótó ọ́fíìsì, gbígbé àti ìjíṣẹ́, àti àwọn iṣẹ́ tí ó máa ń tún padà láti HenryCo Care.",
  },
  hero: {
    eyebrow: "Àkójọ iṣẹ́",
...
const CARE_SERVICES_COPY_HA: DeepPartial<CareServicesCopy> = {
  metadata: {
    ...
    description:
      "Bincika kulawar tufafi, tsaftar gida, tsaftar ofis, ɗauka da kawowa, da ayyuka masu maimaituwa daga HenryCo Care.",
  },
  hero: {
