...
const HUB_HOME_COPY_EN: HubHomeCopy = {
  ...
  standardCard: {
    eyebrow: "Group operating standard",
    title: "One standard, across every division.",
    bullets: [
      "Each division runs with its own market focus, on the same operating standard as the rest of the group.",
      "The hub makes it easy to see who to talk to, where to go, and how the group is organised.",
      "New divisions are introduced inside the same credible structure as the company grows.",
      "Result: stronger public presence, cleaner routing, and a calmer experience at every touchpoint.",
    ],
    latestUpdate: "Last company update",
  ...
  premiumRow: {
    discovery: {
      eyebrow: "Find the right business",
      title: "No guessing where to go",
      text: "One directory covers every operating division, every subdomain, and every public service surface. Search by name, sector, or service; the hub routes you in one step.",
    },
    corporate: {
      eyebrow: "Serious company presence",
      title: "Built for real business",
      text: "Every division sits on the same operating standard, so partners, customers, investors, and media encounter a calm, coherent group \u2014 not a stitched-together set of startups.",
    },
    scale: {
      eyebrow: "Growth without dilution",
      title: "Expands without weakening",
      text: "New divisions and company pages can be introduced inside this framework at any time. The rhythm, copy discipline, and trust signals stay intact as the group grows.",
    },
  },
  featuredSection: {
    eyebrow: "Featured",
  ...
  directory: {
    ...
    title: "Find the exact division you need",
    body: "Search by division name, sector, subdomain, or service emphasis. Filter by status. Every division here is a live operating surface.",
  ...
  ecosystem: {
    ...
    bullets: [
      ...
      "A solid platform for future divisions, campaigns, and announcements.",
      "A credible base for media, investor, and partner-facing communication.",
    ],
    big: [
    ...
    bigText: [
      "Each division grows through its own workflows, public pages, and commercial direction while staying aligned with the parent group.",
      "The company communicates with maturity, clear trust signals, and sharp positioning across markets and audiences.",
      "As new divisions and public initiatives are added, the experience stays clear, consistent, and premium.",
    ],
  },
  access: {
    eyebrow: "Get started",
  ...
  operatingStandard: {
    ...
    principles: [
      ...
      },
      {
        ...
        body: "One platform, built by HenryCo Studio. One team, one standard.",
      },
    ],
  },
  proof: {
...
const HUB_HOME_COPY_IT: DeepPartial<HubHomeCopy> = {
  ...
  "directory": {
    ...
    "searchHelpLink": "Cerca flussi di lavoro e supporto HenryCo",
  ...
  "footer": {
    ...
    "copyrightAllRightsReserved": "Tutti i diritti riservati.",
    "linkPrivacy": "Riservatezza",
    "linkTerms": "Termini",
    "linkPreferences": "Preferenze",
    "designedBy": "Progettato e realizzato internamente da HenryCo Studio per l'ecosistema HenryCo"
  },
  "cards": {
