...
const EN: StudioRequestCopy = {
  copilot: {
    ...
    callsRemaining: (count, noun) => `${count} co-pilot ${noun} left in this window.`,
    draftSingular: "draft",
    draftPlural: "drafts",
...
const FR: DeepPartial<StudioRequestCopy> = {
  copilot: {
    ...
    charactersLeft: (count) => `${count} caractères restants`,
    ...
    callsRemaining: (count, noun) => `${count} ${noun} du co-pilote restant(s) sur cette période.`,
  ...
  builder: {
    ...
    stepProgress: (current, total) => `Étape ${current} / ${total}`,
    percentComplete: (pct) => `${pct}% terminé`,
    progressSaved:
  ...
  path: {
    ...
    depositSuffix: (pct) => `${pct}% d'acompte`,
  ...
  scope: {
    includedLabel: "Inclus",
    selectedCount: (selected, total) => `${selected}/${total} sélectionné(s)`,
...
const ES: DeepPartial<StudioRequestCopy> = {
  copilot: {
    ...
    callsRemaining: (count, noun) => `${count} ${noun} del copiloto restante(s) en esta ventana.`,
  ...
  builder: {
    ...
    stepProgress: (current, total) => `Paso ${current} / ${total}`,
    percentComplete: (pct) => `${pct}% completado`,
    progressSaved:
  ...
  path: {
    ...
    depositSuffix: (pct) => `${pct}% de depósito`,
    projectTypeTitle: "Tipo o categoría de proyecto",
    optionsCount: (count) => `${count} opciones`,
  ...
  scope: {
    includedLabel: "Incluido",
    selectedCount: (selected, total) => `${selected}/${total} seleccionado(s)`,
...
const PT: DeepPartial<StudioRequestCopy> = {
  copilot: {
    ...
    callsRemaining: (count, noun) => `${count} ${noun} do copiloto restante(s) nesta janela.`,
  ...
  builder: {
    ...
    stepProgress: (current, total) => `Passo ${current} / ${total}`,
    percentComplete: (pct) => `${pct}% concluído`,
    progressSaved:
  ...
  scope: {
    includedLabel: "Incluído",
    selectedCount: (selected, total) => `${selected}/${total} selecionado(s)`,
...
const AR: DeepPartial<StudioRequestCopy> = {
  copilot: {
    ...
    charactersLeft: (count) => `${count} حرفًا متبقيًا`,
    trim: "اختصر قليلاً",
    ...
    callsRemaining: (count, noun) => `${count} ${noun} متبقية للمساعد في هذه الفترة.`,
    draftSingular: "مسودة",
    draftPlural: "مسودات",
  ...
  builder: {
    ...
    stepProgress: (current, total) => `الخطوة ${current} / ${total}`,
  ...
  path: {
    ...
    depositSuffix: (pct) => `عربون ${pct}%`,
    projectTypeTitle: "نوع المشروع أو فئته",
    optionsCount: (count) => `${count} خيارات`,
  ...
  scope: {
    includedLabel: "مُضمَّن",
    selectedCount: (selected, total) => `${selected}/${total} محدّد`,
...
const DE: DeepPartial<StudioRequestCopy> = {
  copilot: {
    ...
    charactersLeft: (count) => `${count} Zeichen übrig`,
    trim: "Etwas kürzen",
    ...
    callsRemaining: (count, noun) => `${count} Copilot-${noun} in diesem Zeitraum übrig.`,
  ...
  builder: {
    ...
    stepProgress: (current, total) => `Schritt ${current} / ${total}`,
    percentComplete: (pct) => `${pct}% abgeschlossen`,
    progressSaved:
  ...
  path: {
    ...
    depositSuffix: (pct) => `${pct}% Anzahlung`,
    projectTypeTitle: "Projekttyp oder Kategorie",
    optionsCount: (count) => `${count} Optionen`,
...
const IT: DeepPartial<StudioRequestCopy> = {
  copilot: {
    ...
    charactersLeft: (count) => `${count} caratteri rimanenti`,
    trim: "Accorcia un po'",
    ...
    confidence: (pct) => `Affidabilità ${pct}%`,
    ...
    callsRemaining: (count, noun) => `${count} ${noun} del copilota rimanenti in questa finestra.`,
    draftSingular: "bozza",
    draftPlural: "bozze",
  ...
  builder: {
    ...
    stepProgress: (current, total) => `Passaggio ${current} / ${total}`,
    percentComplete: (pct) => `${pct}% completato`,
    progressSaved:
  ...
  path: {
    ...
    depositSuffix: (pct) => `${pct}% di acconto`,
    projectTypeTitle: "Tipo o categoria di progetto",
    optionsCount: (count) => `${count} opzioni`,
  ...
  scope: {
    includedLabel: "Incluso",
    selectedCount: (selected, total) => `${selected}/${total} selezionati`,
...
const ZH: DeepPartial<StudioRequestCopy> = {
  copilot: {
    ...
    tip: "提示：少于 8 句效果最佳。",
    charactersLeft: (count) => `还可输入 ${count} 个字符`,
    trim: "稍微精简一下",
    ...
    callsRemaining: (count, noun) => `本时段还剩 ${count} 次副驾${noun}。`,
    draftSingular: "草稿",
    draftPlural: "草稿",
    nextSteps: "后续步骤",
  ...
  builder: {
    ...
    back: "返回",
    projectBrief: "项目简报",
    stepProgress: (current, total) => `第 ${current} / ${total} 步`,
  ...
  path: {
    ...
    depositSuffix: (pct) => `${pct}% 定金`,
    projectTypeTitle: "项目类型或类别",
    optionsCount: (count) => `${count} 个选项`,
