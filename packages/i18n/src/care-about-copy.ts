...
const CARE_ABOUT_COPY_EN: CareAboutCopy = {
  ...
  standards: {
    eyebrow: "Why clients trust Henry Onyx Fabric Care",
  ...
  closingCta: {
    eyebrow: "Ready to experience Henry Onyx Fabric Care?",
    title: "Book a premium care service with timing, clarity, and follow-through built in.",
    body: "From garment pickup and delivery to recurring home and office cleaning, Henry Onyx Fabric Care is built to make dependable service feel easy.",
    bookCta: "Book a service",
...
const CARE_ABOUT_COPY_FR: DeepPartial<CareAboutCopy> = {
  ...
  standards: {
    eyebrow: "Pourquoi les clients font confiance à Henry Onyx Fabric Care",
  ...
  closingCta: {
    eyebrow: "Prêt à découvrir Henry Onyx Fabric Care ?",
    title: "Réservez une prestation premium avec ponctualité, clarté et suivi intégrés.",
    body: "De l’enlèvement et de la livraison textile au nettoyage récurrent à domicile et en bureaux, Henry Onyx Fabric Care rend le service fiable simple et naturel.",
    bookCta: "Réserver une prestation",
...
const CARE_ABOUT_COPY_ES: DeepPartial<CareAboutCopy> = {
  ...
  standards: {
    eyebrow: "Por qué los clientes confían en Henry Onyx Fabric Care",
  ...
  closingCta: {
    eyebrow: "¿Listo para vivir Henry Onyx Fabric Care?",
    title: "Reserve un servicio premium con puntualidad, claridad y seguimiento incorporados.",
    body: "Desde la recogida y entrega de prendas hasta la limpieza recurrente del hogar y de oficinas, Henry Onyx Fabric Care está pensado para que el servicio fiable resulte sencillo.",
    bookCta: "Reservar un servicio",
...
const CARE_ABOUT_COPY_PT: DeepPartial<CareAboutCopy> = {
  ...
  standards: {
    eyebrow: "Por que os clientes confiam na Henry Onyx Fabric Care",
  ...
  closingCta: {
    eyebrow: "Pronto para experimentar a Henry Onyx Fabric Care?",
    title: "Reserve um serviço premium com pontualidade, clareza e acompanhamento integrados.",
    body: "Da recolha e entrega de vestuário à limpeza recorrente de lares e escritórios, a Henry Onyx Fabric Care foi pensada para tornar o serviço confiável simples.",
    bookCta: "Reservar um serviço",
...
const CARE_ABOUT_COPY_AR: DeepPartial<CareAboutCopy> = {
  ...
  standards: {
    eyebrow: "لماذا يثق العملاء بـ Henry Onyx Fabric Care",
  ...
  closingCta: {
    eyebrow: "هل أنت مستعد لتجربة Henry Onyx Fabric Care؟",
    title: "احجز خدمة عناية فاخرة مع التزام بالوقت، ووضوح، ومتابعة مدمجة.",
    body: "من استلام الملابس وتوصيلها إلى تنظيف المنازل والمكاتب المتكرر، صُممت Henry Onyx Fabric Care لتجعل الخدمة الموثوقة سهلة وميسّرة.",
    bookCta: "احجز خدمة",
...
const CARE_ABOUT_COPY_DE: DeepPartial<CareAboutCopy> = {
  ...
  standards: {
    eyebrow: "Warum Kunden Henry Onyx Fabric Care vertrauen",
  ...
  closingCta: {
    eyebrow: "Bereit, Henry Onyx Fabric Care zu erleben?",
    title: "Buchen Sie einen Premium-Service mit eingebauter Pünktlichkeit, Klarheit und Nachverfolgung.",
    body: "Von der Abholung und Lieferung von Kleidung bis hin zu wiederkehrender Heim- und Büroreinigung ist Henry Onyx Fabric Care darauf ausgelegt, verlässlichen Service mühelos wirken zu lassen.",
    bookCta: "Service buchen",
...
const CARE_ABOUT_COPY_IT: DeepPartial<CareAboutCopy> = {
  ...
  standards: {
    eyebrow: "Perché i clienti scelgono Henry Onyx Fabric Care",
  ...
  closingCta: {
    eyebrow: "Pronto a provare Henry Onyx Fabric Care?",
    title: "Prenota un servizio premium con puntualità, chiarezza e follow-up integrati.",
    body: "Dal ritiro e dalla consegna degli abiti alla pulizia ricorrente di case e uffici, Henry Onyx Fabric Care è pensata per rendere il servizio affidabile semplice.",
    bookCta: "Prenota un servizio",
...
const CARE_ABOUT_COPY_ZH: DeepPartial<CareAboutCopy> = {
  ...
  standards: {
    eyebrow: "客户为何信任 Henry Onyx Fabric Care",
  ...
  closingCta: {
    eyebrow: "准备好体验 Henry Onyx Fabric Care 了吗?",
    title: "预约一项高端护理服务,守时、清晰与跟进皆已内建。",
    body: "从衣物的上门取送,到家庭与办公室的长期清洁,Henry Onyx Fabric Care 让可靠的服务变得轻松。",
    bookCta: "预约服务",
    exploreCta: "探索服务",
  },
};
const CARE_ABOUT_COPY_HI: DeepPartial<CareAboutCopy> = {
  ...
  standards: {
    eyebrow: "ग्राहक Henry Onyx Fabric Care पर भरोसा क्यों करते हैं",
  ...
  closingCta: {
    eyebrow: "क्या आप Henry Onyx Fabric Care का अनुभव लेने को तैयार हैं?",
    title: "एक प्रीमियम केयर सर्विस बुक करें, जिसमें समयबद्धता, स्पष्टता और फॉलो-थ्रू पहले से ही शामिल हैं।",
    body: "वस्त्र पिकअप और डिलीवरी से लेकर नियमित घरेलू और कार्यालय सफाई तक, Henry Onyx Fabric Care भरोसेमंद सेवा को आसान बनाने के लिए तैयार किया गया है।",
    bookCta: "सर्विस बुक करें",
...
const CARE_ABOUT_COPY_IG: DeepPartial<CareAboutCopy> = {
  ...
  standards: {
    eyebrow: "Ihe kpatara ndị ahịa ji tụkwasị Henry Onyx Fabric Care obi",
  ...
  closingCta: {
    eyebrow: "Ị dị njikere inweta ahụmahụ Henry Onyx Fabric Care?",
    title: "Debe ọrụ nlekọta dị elu nwere oge, nghọta, na nsoghachi etinyere n’ime ya.",
    body: "Site na mbufe na nbubata uwe ruo nhicha ụlọ na nhicha ọfịs na-emegharị, e wuru Henry Onyx Fabric Care iji mee ka ọrụ a pụrụ ịdabere na ya dị mfe.",
    bookCta: "Debe ọrụ",
...
const CARE_ABOUT_COPY_YO: DeepPartial<CareAboutCopy> = {
  ...
  standards: {
    eyebrow: "Ìdí tí àwọn oníbàárà fi gbé Henry Onyx Fabric Care lé",
  ...
  closingCta: {
    eyebrow: "Ṣé o ti múra láti rí Henry Onyx Fabric Care?",
    title: "Sọ iṣẹ́ ìtọ́jú pípé pẹ̀lú àkókò, kíkedere, àti ìtẹ̀lé tí a ti gbé sí inú rẹ̀.",
    body: "Láti gbígba àti ìfijíṣẹ́ aṣọ títí dé ìmọ́tótó ilé àti ọ́fíìsì alábáwí, a ṣe Henry Onyx Fabric Care láti mú kí iṣẹ́ tó gbára lé rọrùn.",
    bookCta: "Sọ iṣẹ́ kan",
...
const CARE_ABOUT_COPY_HA: DeepPartial<CareAboutCopy> = {
  ...
  standards: {
    eyebrow: "Me ya sa abokan ciniki ke amincewa da Henry Onyx Fabric Care",
  ...
  closingCta: {
    eyebrow: "Shin kana shirye don ƙwarewar Henry Onyx Fabric Care?",
    title: "Yi rajistar sabis na kulawa mai inganci tare da lokaci, bayyanawa, da bibiya da aka gina ciki.",
    body: "Daga ɗaukar tufafi da isarwa zuwa tsaftar gida da ofis akai-akai, an gina Henry Onyx Fabric Care don sanya sabis abin dogaro ya zama mai sauƙi.",
    bookCta: "Yi rajistar sabis",
