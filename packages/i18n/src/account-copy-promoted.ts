...
export const ACCOUNT_COPY_ES = {
  ...
  "tasks": {
    ...
    "eyebrow": "Cola de acción · en vivo",
    "guidanceTitle": "Una cola, todas las divisiones.",
    "overviewAria": "Resumen de tareas",
    "volumeAria": "Volumen de tareas",
    "pendingAria": "Tareas pendientes",
    "sideAria": "Cómo funciona la cola",
    "bySource": "Por origen",
    "openTotalLabel": "Total abierto",
    "nothingBlocking": "Nada bloqueando ahora mismo",
    "resolveBlockers": "Resuélvelos para desbloquear otras vías",
    "routine": "habitual",
    "divisionRepresentedSingular": "{count} división representada",
    "divisionRepresentedPlural": "{count} divisiones representadas",
    "headlineEmpty": "Nada en la cola.",
    "headlineBlockerSingular": "{count} bloqueo que resolver.",
    "headlineBlockerPlural": "{count} bloqueos que resolver.",
    "headlineUrgentSingular": "{count} tarea urgente que atender.",
    "headlineUrgentPlural": "{count} tareas urgentes que atender.",
    "headlineActiveSingular": "{count} tarea que completar.",
    "headlineActivePlural": "{count} tareas que completar.",
  ...
  "security": {
    ...
    "hero": {
      ...
      "nextTierAriaTemplate": "Siguiente nivel {tier}",
      "accountActiveSingularTemplate": "Cuenta activa {days} día",
      "accountActivePluralTemplate": "Cuenta activa {days} días",
      "flaggedEventsSingularTemplate": "{count} evento marcado registrado · revise abajo",
      "flaggedEventsPluralTemplate": "{count} eventos marcados registrados · revise abajo",
      "statusEyebrow": {
        "secure": "Seguridad y acceso · seguro",
        "watch": "Seguridad y acceso · acción recomendada",
        "risk": "Seguridad y acceso · riesgo detectado"
      },
      "statusHeadline": {
        "secure": "Tu cuenta está segura.",
        "watch": "Unos pocos pasos reforzarán tu cuenta.",
    ...
    "signalsMeta": "Lo que nuestros motores de verificación y puntuación ven en tu cuenta ahora mismo.",
    "signalsAriaLabel": "Señales de seguridad",
    "guideTitle": "Dónde estás · qué te hace avanzar",
    "guideMetaTemplate": "Puntuación honesta, no un número de marketing. {tier}.",
    "allLanesOpen": "Todas las vías abiertas",
    "accountActionsTitle": "Acciones de cuenta",
    "accountActionsMeta": "Controles habituales que manejas directamente.",
    "changePasswordTitle": "Cambiar tu contraseña",
    "signOutEverywhereTitle": "Cerrar sesión en todos lados",
    "suspiciousEventFoot": "Revisa el flujo de actividad a continuación.",
  ...
  "addresses": {
    "metadata": {
      "title": "Direcciones",
      "description": "Gestiona tus direcciones guardadas (domicilio, oficina, tienda…) — utilizadas para entregas, reservas y verificación KYC."
    },
    "hero": {
      "title": "Direcciones",
      "description": "Gestiona tus direcciones guardadas (domicilio, oficina, tienda…) — utilizadas para entregas, reservas y verificación KYC."
    ...
    "card": {
      ...
      "setDefaultCta": "Establecer como predeterminada",
      "editCta": "Editar",
      "deleteCta": "Eliminar",
      "addressSeparator": ", "
    },
    "deleteConfirm": {
      "prompt": "¿Eliminar esta dirección? Esta acción es irreversible.",
      "confirmCta": "Eliminar",
      "cancelCta": "Cancelar"
    },
    "empty": {
    ...
    "add": {
      ...
      "formTitle": "Añadir nueva dirección",
      "editFormTitleTemplate": "Editar {label}",
      "maxedNoticeTemplate": "Has alcanzado el máximo de {count} tipos de dirección (domicilio, oficina, tienda, almacén, alternativa 1, alternativa 2). Edita o elimina una para añadir otro tipo."
    }
  },
  "search": {
    "metadata": {
...
export const ACCOUNT_COPY_PT = {
  ...
  "tasks": {
    ...
    "eyebrow": "Fila de ação · ao vivo",
    "guidanceTitle": "Uma fila, todas as divisões.",
    "overviewAria": "Resumo de tarefas",
    "volumeAria": "Volume de tarefas",
    "pendingAria": "Tarefas pendentes",
    "sideAria": "Como funciona a fila",
    "bySource": "Por origem",
    "openTotalLabel": "Total aberto",
    "nothingBlocking": "Nada bloqueando agora",
    "resolveBlockers": "Resolva-os para desbloquear outras vias",
    "routine": "habitual",
    "divisionRepresentedSingular": "{count} divisão representada",
    "divisionRepresentedPlural": "{count} divisões representadas",
    "headlineEmpty": "Nada na fila.",
    "headlineBlockerSingular": "{count} bloqueio para resolver.",
    "headlineBlockerPlural": "{count} bloqueios para resolver.",
    "headlineUrgentSingular": "{count} tarefa urgente para atender.",
    "headlineUrgentPlural": "{count} tarefas urgentes para atender.",
    "headlineActiveSingular": "{count} tarefa para concluir.",
    "headlineActivePlural": "{count} tarefas para concluir.",
  ...
  "security": {
    ...
    "hero": {
      ...
      "nextTierPrefix": "Próximo ·",
      "nextTierAriaTemplate": "Próximo nível {tier}",
      "accountActiveSingularTemplate": "Conta ativa {days} dia",
      "accountActivePluralTemplate": "Conta ativa {days} dias",
      "flaggedEventsSingularTemplate": "{count} evento marcado registrado · revise abaixo",
      "flaggedEventsPluralTemplate": "{count} eventos marcados registrados · revise abaixo",
      "statusEyebrow": {
        "secure": "Segurança e acesso · seguro",
        "watch": "Segurança e acesso · ação recomendada",
        "risk": "Segurança e acesso · risco detectado"
      },
      "statusHeadline": {
        "secure": "A sua conta está segura.",
        "watch": "Alguns passos irão reforçar a sua conta.",
    ...
    "signalsTitle": "Sinais",
    "signalsMeta": "O que os nossos motores de verificação e pontuação veem na sua conta agora mesmo.",
    "signalsAriaLabel": "Sinais de segurança",
    "guideTitle": "Onde está · o que o faz avançar",
    "guideMetaTemplate": "Pontuação honesta, não um número de marketing. {tier}.",
    "allLanesOpen": "Todas as vias abertas",
    "accountActionsTitle": "Ações de conta",
    "accountActionsMeta": "Controlos habituais que gere diretamente.",
    "changePasswordTitle": "Alterar a sua senha",
    "signOutEverywhereTitle": "Terminar sessão em todo o lado",
    "suspiciousEventFoot": "Revise o fluxo de atividade abaixo.",
  ...
  "addresses": {
    "metadata": {
      "title": "Endereços",
      "description": "Gira os seus endereços guardados (casa, escritório, loja…) — utilizados para entregas, reservas e verificação KYC."
    },
    "hero": {
      "title": "Endereços",
      "description": "Gira os seus endereços guardados (casa, escritório, loja…) — utilizados para entregas, reservas e verificação KYC."
    ...
    "card": {
      ...
      "kycVerifiedBadge": "KYC verificado",
      "setDefaultCta": "Definir como predefinido",
      "editCta": "Editar",
      "deleteCta": "Eliminar",
      "addressSeparator": ", "
    },
    "deleteConfirm": {
      "prompt": "Eliminar este endereço? Esta ação é irreversível.",
      "confirmCta": "Eliminar",
      "cancelCta": "Cancelar"
    },
    "empty": {
    ...
    "add": {
      ...
      "formTitle": "Adicionar novo endereço",
      "editFormTitleTemplate": "Editar {label}",
      "maxedNoticeTemplate": "Atingiu o máximo de {count} tipos de endereço (casa, escritório, loja, armazém, alternativa 1, alternativa 2). Edite ou elimine um para adicionar outro tipo."
    }
  },
  "search": {
    "metadata": {
