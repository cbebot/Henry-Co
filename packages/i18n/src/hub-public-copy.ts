...
const HUB_PUBLIC_COPY_PT: DeepPartial<HubPublicCopy> = {
  footer: {
    ...
    builtBy: "Concebido e desenvolvido internamente pelo HenryCo Studio para o ecossistema HenryCo",
  },
  contactHero: {
...
const HUB_PUBLIC_COPY_AR: DeepPartial<HubPublicCopy> = {
  footer: {
    ...
    builtBy: "صُمِّمت وطُوِّرت داخليًا في HenryCo Studio لخدمة منظومة HenryCo",
  },
  contactHero: {
...
const HUB_PUBLIC_COPY_DE: DeepPartial<HubPublicCopy> = {
  footer: {
    ...
    builtBy: "Konzipiert und intern entwickelt vom HenryCo Studio für das HenryCo-Ökosystem",
  },
  contactHero: {
...
const HUB_PUBLIC_COPY_IT: DeepPartial<HubPublicCopy> = {
  footer: {
    ...
    builtBy: "Progettato e realizzato internamente da HenryCo Studio per l’ecosistema HenryCo",
  },
  contactHero: {
...
const HUB_PUBLIC_COPY_ZH: DeepPartial<HubPublicCopy> = {
  footer: {
    ...
    builtBy: "由 HenryCo Studio 内部为 HenryCo 生态量身设计与打造",
  },
  contactHero: {
    eyebrow: "联系 Henry & Co.",
    title:
...
const HUB_PUBLIC_COPY_HI: DeepPartial<HubPublicCopy> = {
  footer: {
    ...
    builtBy: "HenryCo Studio द्वारा HenryCo तंत्र के लिए स्वयं अभिकल्पित एवं निर्मित",
  },
  contactHero: {
...
const HUB_PUBLIC_COPY_IG: DeepPartial<HubPublicCopy> = {
  footer: {
    ...
    builtBy: "Atụpụtara ma rụpụta n’ime ụlọ site na HenryCo Studio maka usoro HenryCo",
  },
  contactHero: {
...
const HUB_PUBLIC_COPY_YO: DeepPartial<HubPublicCopy> = {
  footer: {
    ...
    builtBy: "A ṣe àpẹẹrẹ rẹ̀ a sì kọ́ ọ ní ilé nípasẹ̀ HenryCo Studio fún ètò HenryCo",
  },
  contactHero: {
...
const HUB_PUBLIC_COPY_HA: DeepPartial<HubPublicCopy> = {
  footer: {
    ...
    builtBy: "An tsara shi kuma an gina shi a cikin gida ta hannun HenryCo Studio domin tsarin HenryCo",
  },
  contactHero: {
