  ...
  studio: () => [
    {
      ...
      description: "Active Studio project workspace",
    ...
    },
    {
      ...
      description: "Open the Studio brief flow",
      href: "/request",
      external: false,
      icon: <IconStore />,
    },
    {
      ...
      description: "Studio payment questions",
      href: accountSupportHref({
        division: "studio",
    ...
    },
    {
      ...
      description: "Reach the Studio team",
      href: "/contact",
      external: false,
      icon: <IconMessage />,
    },
