...
export function SkipLink({
  ...
  const base =
    "absolute left-4 top-4 z-[100] -translate-y-24 rounded-md bg-zinc-900 px-3 py-2 text-sm font-semibold text-white shadow-lg transition-transform focus-visible:translate-y-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--hc-accent,#C9A227)] focus-visible:ring-offset-2";
  return (
