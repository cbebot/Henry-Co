...
export function SupportThreadExportDocument({ thread, customer, messages }: SupportThreadExportProps) {
  return (
    ...
    >
      ...
      <LegalFooter
        lines={[
          "Attachment file content is intentionally not embedded in this export — only the file name and MIME type are listed. Use Henry Onyx support to retrieve the original files.",
