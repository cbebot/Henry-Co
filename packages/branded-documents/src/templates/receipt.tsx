...
export function ReceiptDocument({ receipt, customer, items }: ReceiptProps) {
  ...
  return (
    ...
    >
      ...
      <LegalFooter
        lines={[
          "This receipt evidences payment captured by Henry Onyx Limited on behalf of the originating division. Tax position reflects the rate in force on the paid date above.",
          "If you spot a discrepancy, contact Henry Onyx support within 7 days for the fastest resolution path.",
        ]}
      />
    </BrandedDocument>
  );
