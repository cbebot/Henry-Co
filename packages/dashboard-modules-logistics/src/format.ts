/**
 * Lightweight formatting helpers for the logistics module's widgets.
...
/**
 * Format a kobo (minor-unit) integer in the given currency. Default
 * `NGN`. Logistics spend is tracked in minor units.
 */
...
/**
 * Map the module's internal quick-action group to the shell palette's
 * group label union.
 */
