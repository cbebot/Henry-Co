...
export type HenryExperimentGuardrail = {
  boundary: HenryExperimentBoundary;
  label: string;
  description: string;
  allowed: boolean;
...
export type HenryExperimentDivisionReadiness = {
  division: string;
  totalRows: number;
  safeRows: number;
  restrictedRows: number;
  highRiskRows: number;
  notificationLinkedRows: number;
};

export type HenryExperimentReadinessSummary = {
  totalRows: number;
  safeRows: number;
  restrictedRows: number;
  highRiskRows: number;
  financeSensitiveRows: number;
  trustSensitiveRows: number;
  supportSensitiveRows: number;
  notificationLinkedRows: number;
  ownerVisibleSafeRows: number;
  operatorVisibleSafeRows: number;
  divisions: HenryExperimentDivisionReadiness[];
  guardrails: HenryExperimentGuardrail[];
};
...
export const HENRY_EXPERIMENT_GUARDRAILS: HenryExperimentGuardrail[] = [
  {
    boundary: "safe_ui",
    label: "Safe UI",
    description: "Presentation, copy hierarchy, and low-risk interface variations backed by the same underlying workflow.",
    allowed: true,
  ...
  },
  {
    boundary: "content",
    label: "Content",
    description: "Headline, helper text, and merchandising language changes where business logic does not change.",
    allowed: true,
    restrictedReason: null,
  },
  {
    boundary: "navigation",
    label: "Navigation",
    description: "Wayfinding, placement, and discovery improvements that do not alter trust, payment, or support state transitions.",
    allowed: true,
    restrictedReason: null,
  },
  {
    boundary: "operator_reporting",
    label: "Operator reporting",
    description: "Owner and operator dashboard presentation experiments using the same underlying event truth.",
    allowed: true,
    restrictedReason: null,
  },
  {
    boundary: "non_financial_ranking",
    label: "Non-financial ranking",
    description: "Ranking and recommendation tuning that avoids finance settlement, trust gating, and support lifecycle logic.",
    allowed: true,
    restrictedReason: null,
  },
  {
    boundary: "high_risk",
    label: "High risk",
    description: "Auth, finance, trust, KYC, or support lifecycle flows where randomization can corrupt operational truth.",
    allowed: false,
    restrictedReason: "Do not experiment on finance, trust, auth, or support lifecycle behavior without a separate guarded program.",
  },
];
...
const HIGH_SIGNAL_ACTIVITY_DESCRIPTORS: Record<string, HenryAnalyticsDescriptor> = {
  ...
  "marketplace:wishlist_removed": {
    canonicalName: "henry.marketplace.wishlist.updated",
    classification: "user_action",
    defaultOutcome: "removed",
    entityType: "product",
  },
  "marketplace:vendor_followed": {
  ...
  "marketplace:checkout_started": {
    canonicalName: "henry.marketplace.checkout.started",
    classification: "user_action",
    funnelKey: "marketplace_purchase",
  ...
  "marketplace:order_placed": {
    canonicalName: "henry.marketplace.order.placed",
    classification: "user_action",
    funnelKey: "marketplace_purchase",
    funnelStep: "order_placed",
    defaultOutcome: "submitted",
    entityType: "order",
    touches: { finance: true },
  },
  "marketplace:payment_verified": {
    canonicalName: "henry.marketplace.payment.verified",
    classification: "system_state",
    funnelKey: "marketplace_purchase",
    funnelStep: "order_paid",
    defaultOutcome: "paid",
    entityType: "order",
    touches: { finance: true, trust: true },
  },
  "marketplace:order_confirmed": {
    canonicalName: "henry.marketplace.order.confirmed",
    classification: "system_state",
    funnelKey: "marketplace_purchase",
    funnelStep: "order_fulfillment",
    defaultOutcome: "completed",
    entityType: "order",
    touches: { finance: true },
  },
  "marketplace:order_packed": {
    canonicalName: "henry.marketplace.order.packed",
    classification: "system_state",
    funnelKey: "marketplace_purchase",
    funnelStep: "order_fulfillment",
    defaultOutcome: "updated",
  ...
  "marketplace:order_shipped": {
    canonicalName: "henry.marketplace.order.shipped",
    classification: "system_state",
    funnelKey: "marketplace_purchase",
    funnelStep: "order_fulfillment",
    defaultOutcome: "updated",
  ...
  "marketplace:order_delivered": {
    canonicalName: "henry.marketplace.order.delivered",
    classification: "system_state",
    funnelKey: "marketplace_purchase",
    funnelStep: "order_fulfillment",
    defaultOutcome: "delivered",
    entityType: "order_group",
    touches: { finance: true },
  },
  "marketplace:order_delayed": {
    canonicalName: "henry.marketplace.order.delayed",
    classification: "system_state",
    funnelKey: "marketplace_purchase",
    funnelStep: "order_fulfillment",
    defaultOutcome: "blocked",
  ...
  "marketplace:vendor_application_submitted": {
    canonicalName: "henry.marketplace.vendor_application.submitted",
    classification: "user_action",
    defaultOutcome: "submitted",
    entityType: "vendor_application",
    touches: { trust: true },
  },
  "marketplace:vendor_application_approved": {
    canonicalName: "henry.marketplace.vendor_application.resolved",
    classification: "system_state",
    defaultOutcome: "approved",
    entityType: "vendor_application",
    touches: { trust: true },
  },
  "marketplace:vendor_application_rejected": {
    canonicalName: "henry.marketplace.vendor_application.resolved",
    classification: "system_state",
  ...
  "marketplace:vendor_application_changes_requested": {
    canonicalName: "henry.marketplace.vendor_application.resolved",
    classification: "system_state",
    defaultOutcome: "blocked",
    entityType: "vendor_application",
  ...
  "marketplace:payout_requested": {
    canonicalName: "henry.marketplace.payout.requested",
    classification: "user_action",
    defaultOutcome: "requested",
  ...
  "marketplace:dispute_opened": {
    canonicalName: "henry.marketplace.dispute.opened",
    classification: "user_action",
    defaultOutcome: "submitted",
    entityType: "dispute",
    touches: { support: true, trust: true, finance: true },
  },
  "marketplace:dispute_updated": {
    canonicalName: "henry.marketplace.dispute.updated",
    classification: "system_state",
    defaultOutcome: "updated",
    entityType: "dispute",
    touches: { support: true, trust: true, finance: true },
  ...
  "marketplace:dispute_resolved": {
    canonicalName: "henry.marketplace.dispute.resolved",
    classification: "system_state",
    defaultOutcome: "resolved",
    entityType: "dispute",
    touches: { support: true, trust: true, finance: true },
...
function descriptorForActivity(input: MetadataBuildInput): HenryAnalyticsDescriptor {
  ...
  if (descriptor) {
    ...
    if (key === "jobs:jobs_application" && status && status !== "applied") {
      return {
        ...descriptor,
        funnelStep: "application_progressed",
        defaultOutcome:
          status === "rejected"
            ? "rejected"
            : status === "interview" || status === "offer"
              ? "approved"
              : descriptor.defaultOutcome,
      };
    }

    if (key === "care:care_booking" && status) {
      return {
        ...descriptor,
        funnelStep:
          status === "completed" || status === "delivered"
            ...
            : status === "requested"
              ? "booking_requested"
              : "booking_confirmed",
        defaultOutcome: inferOutcome(status),
      };
    }
...
export function summarizeFunnels(rows: HenryActivityRowLike[]): HenryFunnelSummary[] {
  ...
  return HENRY_FUNNEL_DEFINITIONS.map((definition) => {
    ...
    const firstObservedStep = steps.find((step) => step.count > 0) || null;
    const participants = firstObservedStep?.count || 0;
...
export function summarizeExperimentReadiness(
  rows: HenryActivityRowLike[]
): HenryExperimentReadinessSummary {
  const normalized = rows.map(readActivityAnalytics).filter((row): row is HenryNormalizedActivityRow => Boolean(row));
  const divisionMap = new Map<string, HenryExperimentDivisionReadiness>();

  const isSafeRow = (row: HenryNormalizedActivityRow) =>
    row.analytics.experimentSafe &&
    !row.analytics.touches.finance &&
    !row.analytics.touches.trust &&
    !row.analytics.touches.support;

  const isHighRiskRow = (row: HenryNormalizedActivityRow) =>
    !row.analytics.experimentSafe ||
    row.analytics.touches.finance ||
    row.analytics.touches.trust ||
    row.analytics.touches.support;
  ...
  for (const row of normalized) {
    const current = divisionMap.get(row.division) || {
      division: row.division,
      totalRows: 0,
      safeRows: 0,
      restrictedRows: 0,
      highRiskRows: 0,
      notificationLinkedRows: 0,
    };
    ...
    if (isSafeRow(row)) {
      ...
      current.restrictedRows += 1;
    }
    if (isHighRiskRow(row)) {
      current.highRiskRows += 1;
    }
    if (row.analytics.touches.notification) {
      current.notificationLinkedRows += 1;
    }

    divisionMap.set(row.division, current);
  }

  return {
    totalRows: normalized.length,
    safeRows: normalized.filter(isSafeRow).length,
    restrictedRows: normalized.filter((row) => !isSafeRow(row)).length,
    highRiskRows: normalized.filter(isHighRiskRow).length,
    financeSensitiveRows: normalized.filter((row) => row.analytics.touches.finance).length,
    trustSensitiveRows: normalized.filter((row) => row.analytics.touches.trust).length,
    supportSensitiveRows: normalized.filter((row) => row.analytics.touches.support).length,
    notificationLinkedRows: normalized.filter((row) => row.analytics.touches.notification).length,
    ownerVisibleSafeRows: normalized.filter((row) => isSafeRow(row) && row.analytics.ownerVisible).length,
    operatorVisibleSafeRows: normalized.filter((row) => isSafeRow(row) && row.analytics.operatorVisible).length,
    divisions: [...divisionMap.values()].sort(
      (left, right) =>
        right.restrictedRows - left.restrictedRows || right.safeRows - left.safeRows
    ),
    guardrails: HENRY_EXPERIMENT_GUARDRAILS,
  };
}
