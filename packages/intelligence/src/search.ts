...
const publicCatalog: CrossDivisionSearchResult[] = [
  defineResult({
    ...
    description: "Find divisions, workflows, help routes, and major destinations across Henry Onyx.",
  ...
  defineResult({
    ...
    division: "hub",
    type: "division",
    title: "Henry Onyx divisions directory",
    subtitle: "Find a division",
    description: "Browse every live Henry Onyx division from the central hub.",
  ...
  defineResult({
    ...
    type: "page",
    title: "Care services",
    subtitle: "What Henry Onyx Care offers",
  ...
  defineResult({
    ...
    type: "page",
    title: "Care pricing",
    subtitle: "Service pricing and packages",
    description: "Review garment, home, and office service pricing before booking.",
    href: divisionHref("care", "/pricing"),
    authRequirement: "none",
    visibility: "public",
    badge: "Pricing",
    icon: "receipt",
    priority: 86,
    source: "shared_catalog",
    tags: ["care", "pricing", "price", "rate", "rates", "estimate", "cost", "package", "packages"],
  }),
  defineResult({
    id: "care-review",
    division: "care",
    type: "workflow",
    title: "Leave a Care review",
    subtitle: "Rate a completed booking",
    description: "Use your tracking code to leave a review after a service is finished.",
    href: divisionHref("care", "/review"),
    authRequirement: "none",
    visibility: "public",
    badge: "Review",
    icon: "message-square",
    priority: 80,
    source: "shared_catalog",
    tags: ["care", "review", "reviews", "rate", "rating", "feedback", "testimonial"],
  }),
  defineResult({
    id: "care-about",
    division: "care",
    ...
    subtitle: "Service standards and operations",
    description: "How Henry Onyx Care operates pickup, treatment, on-site work, and follow-up.",
    href: divisionHref("care", "/about"),
    authRequirement: "none",
    visibility: "public",
    badge: "About",
    icon: "compass",
    priority: 76,
    source: "shared_catalog",
    tags: ["care", "about", "company", "standards", "operations", "team"],
  }),
  defineResult({
    id: "care-book",
    division: "care",
  ...
  defineResult({
    ...
    description: "Reach Henry Onyx Care for booking or service support.",
  ...
  defineResult({
    id: "marketplace-track",
    division: "marketplace",
    type: "marketplace_order",
    title: "Track marketplace order",
    subtitle: "Order tracking",
    description: "Track a marketplace order using its reference code.",
    href: divisionHref("marketplace", "/track"),
    authRequirement: "none",
    visibility: "public",
    badge: "Track",
    icon: "package",
    priority: 92,
    source: "shared_catalog",
    tags: ["marketplace", "track", "order", "orders", "tracking", "delivery status", "shipment"],
  }),
  defineResult({
    id: "marketplace-cart",
    division: "marketplace",
    ...
    description: "Open your shopping cart and complete checkout.",
    href: divisionHref("marketplace", "/cart"),
    authRequirement: "none",
    visibility: "public",
    badge: "Cart",
    icon: "shopping-bag",
    priority: 88,
    source: "shared_catalog",
    tags: ["marketplace", "cart", "checkout", "basket", "buy", "purchase"],
  }),
  defineResult({
    id: "marketplace-trust",
    division: "marketplace",
    type: "page",
    title: "Marketplace trust standards",
    subtitle: "Vendor verification and protection",
    description: "How Henry Onyx Marketplace verifies vendors, products, and protects buyers.",
    href: divisionHref("marketplace", "/trust"),
    authRequirement: "none",
    visibility: "public",
    badge: "Trust",
    icon: "shield",
    priority: 80,
    source: "shared_catalog",
    tags: ["marketplace", "trust", "verification", "vetting", "buyer protection", "guarantee"],
  }),
  defineResult({
    ...
    description: "Browse curated themes, drops, and seasonal collections.",
    href: divisionHref("marketplace", "/collections"),
    authRequirement: "none",
    visibility: "public",
    badge: "Browse",
    icon: "shopping-bag",
    priority: 78,
    source: "shared_catalog",
    tags: ["marketplace", "collections", "drops", "curated", "themes", "seasonal"],
  }),
  defineResult({
    id: "jobs-division",
    division: "jobs",
  ...
  defineResult({
    ...
    division: "jobs",
    type: "workflow",
    title: "Hire with Henry Onyx Jobs",
  ...
  defineResult({
    ...
    division: "jobs",
    type: "job_listing",
    title: "Verified talent directory",
    subtitle: "Browse vetted candidates",
    description: "Browse Henry Onyx Jobs verified-talent directory by skill, location, and availability.",
    href: divisionHref("jobs", "/talent"),
    authRequirement: "none",
    visibility: "public",
    badge: "Talent",
    icon: "users",
    priority: 88,
    source: "shared_catalog",
    tags: ["jobs", "talent", "verified", "candidates", "directory", "freelancers", "hire"],
  }),
  defineResult({
    id: "jobs-categories",
    division: "jobs",
    ...
    subtitle: "Roles by industry and discipline",
    description: "Open the jobs category index — engineering, design, ops, finance, and more.",
    href: divisionHref("jobs", "/categories"),
    authRequirement: "none",
    visibility: "public",
    badge: "Categories",
    icon: "briefcase",
    priority: 80,
    source: "shared_catalog",
    tags: ["jobs", "categories", "industry", "discipline", "engineering", "design", "browse"],
  }),
  defineResult({
    id: "jobs-careers",
    division: "jobs",
    type: "job_listing",
    title: "Careers at Henry Onyx",
    subtitle: "Internal Henry Onyx openings",
    description: "Open roles inside Henry Onyx — work directly with the company team.",
    ...
    priority: 86,
    source: "shared_catalog",
    tags: ["careers", "internal jobs", "henryco careers", "company", "work at henryco"],
  }),
  defineResult({
    id: "jobs-trust",
    division: "jobs",
    type: "page",
    title: "Jobs trust and safety",
    subtitle: "Verification and protections",
    description: "How Henry Onyx Jobs verifies employers, screens candidates, and prevents scams.",
    href: divisionHref("jobs", "/trust"),
    authRequirement: "none",
    visibility: "public",
    badge: "Trust",
    icon: "shield",
    priority: 80,
    source: "shared_catalog",
    tags: ["jobs", "trust", "safety", "verification", "scam", "fraud", "protection"],
  }),
  defineResult({
    id: "learn-division",
    division: "learn",
  ...
  defineResult({
    ...
    priority: 95,
    source: "shared_catalog",
    tags: ["learn", "courses", "catalog", "academy", "training", "classes", "lessons", "study"],
  }),
  defineResult({
    id: "learn-paths",
    division: "learn",
    type: "learn_course",
    title: "Learn paths",
    subtitle: "Guided learning paths",
    description: "Browse multi-course learning paths grouped by skill outcome.",
    href: divisionHref("learn", "/paths"),
    authRequirement: "none",
    visibility: "public",
    badge: "Paths",
    icon: "graduation-cap",
    priority: 90,
    source: "shared_catalog",
    tags: ["learn", "paths", "learning paths", "guided", "skills", "outcome"],
  }),
  defineResult({
    id: "learn-academy",
    division: "learn",
    type: "page",
    title: "How Henry Onyx Learn works",
    subtitle: "Academy overview",
    description: "How lessons, assessments, and verification work on Henry Onyx Learn.",
    href: divisionHref("learn", "/academy"),
    authRequirement: "none",
    visibility: "public",
    badge: "How it works",
    icon: "graduation-cap",
    priority: 80,
    source: "shared_catalog",
    tags: ["learn", "academy", "how it works", "process", "assessments", "verification"],
  }),
  defineResult({
    id: "learn-teach",
    division: "learn",
    type: "workflow",
    title: "Teach with Henry Onyx",
    subtitle: "Become an instructor",
    description: "Apply to teach on Henry Onyx Learn — propose courses, share credentials, and earn from enrolments.",
    href: divisionHref("learn", "/teach"),
    authRequirement: "none",
    visibility: "public",
    badge: "Teach",
    icon: "graduation-cap",
  ...
  defineResult({
    ...
    division: "learn",
    type: "page",
    title: "Learn trust and standards",
    subtitle: "Quality and verification",
    description: "How Henry Onyx Learn vets instructors, courses, and certificates.",
    href: divisionHref("learn", "/trust"),
    authRequirement: "none",
    visibility: "public",
    badge: "Trust",
    icon: "shield",
    priority: 80,
    source: "shared_catalog",
    tags: ["learn", "trust", "standards", "vetting", "quality", "instructors"],
  }),
  defineResult({
    id: "learn-help",
    division: "learn",
  ...
  defineResult({
    ...
    description: "Book a dispatch or delivery with Henry Onyx Logistics.",
  ...
  defineResult({
    ...
    division: "property",
    type: "page",
    title: "Property trust standards",
    subtitle: "Vetting and verification",
    description: "How Henry Onyx Property vets owners, listings, and resolves disputes.",
    href: divisionHref("property", "/trust"),
    authRequirement: "none",
    visibility: "public",
    badge: "Trust",
    icon: "shield",
    priority: 80,
    source: "shared_catalog",
    tags: ["property", "trust", "vetting", "verification", "moderation", "standards"],
  }),
  defineResult({
    id: "property-agent",
    division: "property",
    type: "page",
    title: "Property agent surface",
    subtitle: "For agents and partners",
    description: "Tools and workflows for property agents listing and managing inquiries.",
    href: divisionHref("property", "/agent"),
    authRequirement: "none",
    visibility: "public",
    badge: "Agents",
    icon: "users",
    priority: 78,
    source: "shared_catalog",
    tags: ["property", "agent", "agents", "broker", "partner", "realtor"],
  }),
  defineResult({
    id: "studio-division",
    division: "studio",
  ...
  defineResult({
    ...
    description: "Browse Henry Onyx Studio services and delivery offerings.",
  ...
  defineResult({
    ...
    description: "Start the project request flow for Henry Onyx Studio.",
  ...
  defineResult({
    ...
    description: "Reach Henry Onyx Studio for sales, project, and support questions.",
  ...
  defineResult({
    ...
    division: "studio",
    type: "studio_service",
    title: "Studio packages and pricing",
    subtitle: "Milestone pricing",
    description: "Compare Studio packages, scope tiers, and milestone pricing.",
    href: divisionHref("studio", "/pricing"),
    authRequirement: "none",
    visibility: "public",
    badge: "Packages",
    icon: "receipt",
    priority: 87,
    source: "shared_catalog",
    tags: ["studio", "pricing", "packages", "package", "milestone", "estimate", "cost", "rate"],
  }),
  defineResult({
    id: "studio-pick",
    division: "studio",
    type: "workflow",
    title: "Pick a Studio project type",
    subtitle: "Guided project selector",
    description: "Answer a few prompts and we'll route you to the right Studio path.",
    href: divisionHref("studio", "/pick"),
    authRequirement: "none",
    visibility: "public",
    badge: "Picker",
    icon: "compass",
    priority: 85,
    source: "shared_catalog",
    tags: ["studio", "pick", "picker", "selector", "guide", "what should i build"],
  }),
  defineResult({
    id: "studio-process",
    division: "studio",
    ...
    subtitle: "How delivery works",
    description: "How Studio scopes, plans, builds, and hands off projects.",
    href: divisionHref("studio", "/process"),
    authRequirement: "none",
    visibility: "public",
    badge: "Process",
    icon: "compass",
    priority: 78,
    source: "shared_catalog",
    tags: ["studio", "process", "delivery", "how it works", "method", "workflow"],
  }),
  defineResult({
    id: "studio-trust",
    division: "studio",
    type: "page",
    title: "Studio trust and standards",
    subtitle: "How we work with clients",
    description: "Confidentiality, IP, milestone pricing, and project safeguards on Henry Onyx Studio.",
    href: divisionHref("studio", "/trust"),
    authRequirement: "none",
    visibility: "public",
    badge: "Trust",
    icon: "shield",
    priority: 80,
    source: "shared_catalog",
    tags: ["studio", "trust", "ip", "confidentiality", "contracts", "safeguards"],
  }),
  defineResult({
    id: "studio-teams",
    division: "studio",
    type: "page",
    title: "Studio teams",
    subtitle: "Pods and specialists",
    description: "Meet the Henry Onyx Studio pods and specialists behind delivery.",
    href: divisionHref("studio", "/teams"),
    authRequirement: "none",
    visibility: "public",
    badge: "Teams",
    icon: "users",
    priority: 76,
    source: "shared_catalog",
    tags: ["studio", "teams", "pods", "specialists", "people", "designers", "engineers"],
  }),
  defineResult({
    ...
    subtitle: "Recurring dispatch programs",
    description: "Recurring dispatch, account-based pickup, and B2B logistics programs.",
    href: divisionHref("logistics", "/business"),
    authRequirement: "none",
    visibility: "public",
    badge: "Business",
    icon: "truck",
    priority: 80,
    source: "shared_catalog",
    tags: ["logistics", "business", "b2b", "recurring", "account", "enterprise", "company"],
  }),
  defineResult({
    id: "logistics-coverage",
    division: "logistics",
    type: "page",
    title: "Logistics coverage areas",
    subtitle: "Where Henry Onyx delivers",
    description: "Service zones, coverage areas, and pickup-delivery footprint for Henry Onyx Logistics.",
    href: divisionHref("logistics", "/coverage"),
    authRequirement: "none",
    visibility: "public",
    badge: "Coverage",
    icon: "map-pin",
    priority: 76,
    source: "shared_catalog",
    tags: ["logistics", "coverage", "areas", "zones", "service area", "where", "city"],
  }),
];
...
const authenticatedCatalog: CrossDivisionSearchResult[] = [
  defineResult({
    ...
    subtitle: "Henry Onyx account home",
    description: "Open your Henry Onyx account dashboard.",
    href: getAccountUrl("/"),
  ...
  defineResult({
    ...
    description: "Review Henry Onyx notifications across services.",
  ...
  defineResult({
    ...
    description: "Open existing Henry Onyx support threads and requests.",
  ...
  defineResult({
    ...
    subtitle: "New ticket",
    description: "Start a new Henry Onyx support request.",
  ...
  defineResult({
    ...
    description: "Open issued Henry Onyx Learn certificates.",
