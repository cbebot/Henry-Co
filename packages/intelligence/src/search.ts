...
const publicCatalog: CrossDivisionSearchResult[] = [
  ...
  defineResult({
    ...
    description: "How HenryCo Care operates pickup, treatment, on-site work, and follow-up.",
  ...
  defineResult({
    ...
    description: "How HenryCo Marketplace verifies vendors, products, and protects buyers.",
  ...
  defineResult({
    ...
    description: "Browse HenryCo Jobs verified-talent directory by skill, location, and availability.",
  ...
  defineResult({
    ...
    description: "How HenryCo Jobs verifies employers, screens candidates, and prevents scams.",
  ...
  defineResult({
    ...
    division: "learn",
    type: "page",
    title: "How HenryCo Learn works",
    subtitle: "Academy overview",
    description: "How lessons, assessments, and verification work on HenryCo Learn.",
  ...
  defineResult({
    ...
    description: "Apply to teach on HenryCo Learn — propose courses, share credentials, and earn from enrolments.",
  ...
  defineResult({
    ...
    description: "How HenryCo Learn vets instructors, courses, and certificates.",
  ...
  defineResult({
    ...
    description: "How HenryCo Property vets owners, listings, and resolves disputes.",
  ...
  defineResult({
    ...
    description: "Confidentiality, IP, milestone pricing, and project safeguards on HenryCo Studio.",
  ...
  defineResult({
    ...
    description: "Meet the HenryCo Studio pods and specialists behind delivery.",
  ...
  defineResult({
    ...
    description: "Service zones, coverage areas, and pickup-delivery footprint for HenryCo Logistics.",
