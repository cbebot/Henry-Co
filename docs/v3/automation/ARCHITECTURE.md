...
**Pass:** V3-F-DESIGN-01 · Design only. Type shapes and SQL here are **design contracts**, not shipped code — written concretely so the build passes (V3-43…48) have no ambiguity. Anchored on `origin/main @ 8c9794b5`; trust the named symbols over line numbers.
