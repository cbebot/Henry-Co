      ...
      <div className="mx-auto max-w-7xl space-y-12 px-4 py-12 sm:px-6 lg:px-8">
        ...
        <section>
          ...
          {jobs.length > 0 ? (
            ...
            <div className="mt-8">
              <EmptyState
                kicker={t("No openings right now")}
                title={t("We don't have any internal roles open at the moment")}
                body={t("Check back soon or browse external roles from verified employers on the main board.")}
                action={
                  <Link
                    href="/jobs"
