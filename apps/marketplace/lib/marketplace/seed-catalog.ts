...
// The marketplace category taxonomy. Broad enough that a seller of almost anything
// finds a home — fashion, beauty, groceries, automotive, and the rest of everyday
// commerce — while the first four stay the curated house-featured lanes. Copy is
// plain and specific (company voice); the DB is the source of truth (see the
// companion migration that seeds these idempotently on slug).
export const seedCategories: SeedCategory[] = [
  ...
  },
  {
    ...
    description: "Clothing for men, women, and children — everyday wear to occasion pieces.",
    hero_copy: "Dress the day your way — apparel with honest sizing and clear materials.",
    sort_order: 5,
    is_featured: true,
    filter_presets: ["verified", "fast_delivery", "cod"],
    trust_notes: ["Size guides included", "Material stated", "Easy returns window"],
  },
  {
    slug: "shoes-footwear",
    name: "Shoes & Footwear",
    description: "Sneakers, formal shoes, sandals, and boots for every day and occasion.",
    hero_copy: "Footwear that fits and lasts — sized honestly, described plainly.",
    sort_order: 6,
    is_featured: false,
    filter_presets: ["verified", "cod", "fast_delivery"],
    trust_notes: ["True-to-size notes", "Authenticity checked", "COD eligible"],
  },
  {
    slug: "bags-accessories",
    name: "Bags & Accessories",
    description: "Bags, belts, wallets, and the finishing pieces that pull an outfit together.",
    hero_copy: "Carry it well — bags and accessories with honest materials and clear specs.",
    sort_order: 7,
    is_featured: false,
    filter_presets: ["verified", "fast_delivery"],
    trust_notes: ["Material stated", "Quality-checked", "Gift-ready"],
  },
  {
    slug: "jewelry-watches",
    name: "Jewelry & Watches",
    description: "Watches, rings, chains, and everyday jewelry — stated materials, no guesswork.",
    hero_copy: "Pieces worth keeping — with materials stated and authenticity checked.",
    sort_order: 8,
    is_featured: false,
    filter_presets: ["verified", "company_owned"],
    trust_notes: ["Material stated", "Authenticity checked", "Gift-ready packaging"],
  },
  {
    slug: "beauty-personal-care",
    name: "Beauty & Personal Care",
    description: "Skincare, haircare, fragrance, and grooming from trusted sellers.",
    hero_copy: "Look after yourself — beauty and care products with honest ingredients.",
    sort_order: 9,
    is_featured: true,
    filter_presets: ["verified", "cod", "fast_delivery"],
    trust_notes: ["Ingredients listed", "Authenticity checked", "Sealed on dispatch"],
  },
  {
    slug: "health-wellness",
    name: "Health & Wellness",
    description: "Supplements, fitness aids, and personal-health essentials.",
    hero_copy: "Everyday wellbeing — health products with clear labels and honest claims.",
    sort_order: 10,
    is_featured: false,
    filter_presets: ["verified", "cod"],
    trust_notes: ["Labels stated", "No overstated claims", "Sealed on dispatch"],
  },
  {
    slug: "phones-tablets",
    name: "Phones & Tablets",
    description: "Smartphones, tablets, and the cases, chargers, and cover around them.",
    hero_copy: "Stay connected — phones and tablets, authenticity checked before dispatch.",
    sort_order: 11,
    is_featured: true,
    filter_presets: ["verified", "fast_delivery", "company_owned"],
    trust_notes: ["Authenticity checked", "Warranty stated", "Fast dispatch"],
  },
  {
    slug: "computers-laptops",
    name: "Computers & Laptops",
    description: "Laptops, desktops, monitors, and the components that keep them running.",
    hero_copy: "Kit that keeps up — computing gear with honest specs and warranty.",
    sort_order: 12,
    is_featured: false,
    filter_presets: ["verified", "company_owned"],
    trust_notes: ["Specs verified", "Warranty included", "Tested before dispatch"],
  },
  {
    slug: "audio-headphones",
    name: "Audio & Headphones",
    description: "Headphones, earbuds, speakers, and sound gear for home and on the move.",
    hero_copy: "Sound you can trust — audio gear, authenticity checked and ready to ship.",
    sort_order: 13,
    is_featured: false,
    filter_presets: ["verified", "fast_delivery", "cod"],
    trust_notes: ["Authenticity checked", "Warranty stated", "Fast dispatch"],
  },
  {
    slug: "gaming",
    name: "Gaming",
    description: "Consoles, games, controllers, and the accessories for serious play.",
    hero_copy: "Game on — consoles and accessories, verified and dispatch-ready.",
    sort_order: 14,
    is_featured: false,
    filter_presets: ["verified", "fast_delivery"],
    trust_notes: ["Authenticity checked", "Warranty stated", "Fast dispatch"],
  },
  {
    ...
    description: "Fridges, cookers, fans, and the appliances a household runs on.",
    hero_copy: "The appliances that carry the home — capacity-tested with warranty.",
    sort_order: 15,
    is_featured: false,
    filter_presets: ["verified", "company_owned"],
    trust_notes: ["Capacity-tested", "Warranty included", "Install guidance"],
  },
  {
    slug: "furniture",
    name: "Furniture",
    description: "Sofas, beds, tables, and storage — built to hold up at home and work.",
    hero_copy: "Furniture that lasts — honest materials, clear dimensions, real delivery notes.",
    sort_order: 16,
    is_featured: false,
    filter_presets: ["verified", "company_owned"],
    trust_notes: ["Dimensions stated", "Material stated", "Delivery notes clear"],
  },
  {
    slug: "kitchen-dining",
    name: "Kitchen & Dining",
    description: "Cookware, utensils, dinnerware, and the tools of a working kitchen.",
    hero_copy: "A kitchen that works — cookware and dining goods with honest specs.",
    sort_order: 17,
    is_featured: false,
    filter_presets: ["verified", "cod", "fast_delivery"],
    trust_notes: ["Material stated", "Company stocked", "Gift-ready"],
  },
  {
    slug: "groceries-gourmet",
    name: "Groceries & Gourmet",
    description: "Pantry staples, packaged foods, and gourmet finds from trusted sellers.",
    hero_copy: "Stock the pantry — groceries and gourmet goods with clear dates and labels.",
    sort_order: 18,
    is_featured: false,
    filter_presets: ["verified", "cod", "fast_delivery"],
    trust_notes: ["Dates stated", "Sealed on dispatch", "COD eligible"],
  },
  {
    slug: "baby-kids",
    name: "Baby & Kids",
    description: "Baby care, kids' clothing, and the essentials families reach for daily.",
    hero_copy: "For the little ones — baby and kids' goods with honest, safe specs.",
    sort_order: 19,
    is_featured: false,
    filter_presets: ["verified", "cod", "fast_delivery"],
    trust_notes: ["Age ranges stated", "Material stated", "Sealed on dispatch"],
  },
  {
    slug: "toys-games",
    name: "Toys & Games",
    description: "Toys, board games, and play gear for every age.",
    hero_copy: "Play that lasts — toys and games with age guidance and honest specs.",
    sort_order: 20,
    is_featured: false,
    filter_presets: ["verified", "cod", "fast_delivery"],
    trust_notes: ["Age ranges stated", "Quality-checked", "Gift-ready"],
  },
  {
    slug: "sports-fitness",
    name: "Sports & Fitness",
    description: "Gym gear, sportswear, and equipment for training and the outdoors.",
    hero_copy: "Train hard — sports and fitness gear built to take the work.",
    sort_order: 21,
    is_featured: false,
    filter_presets: ["verified", "fast_delivery", "cod"],
    trust_notes: ["Material stated", "Quality-checked", "Fast dispatch"],
  },
  {
    slug: "automotive-tools",
    name: "Automotive & Tools",
    description: "Car care, parts, power tools, and hardware for the garage and site.",
    hero_copy: "Keep it running — automotive parts and tools with honest specs.",
    sort_order: 22,
    is_featured: false,
    filter_presets: ["verified", "company_owned"],
    trust_notes: ["Fitment noted", "Warranty stated", "Tested before dispatch"],
  },
  {
    slug: "books-stationery",
    name: "Books & Stationery",
    description: "Books, notebooks, and the desk supplies that keep work and study moving.",
    hero_copy: "Read and write — books and stationery, curated and dispatch-ready.",
    sort_order: 23,
    is_featured: false,
    filter_presets: ["verified", "cod", "fast_delivery"],
    trust_notes: ["Condition stated", "Company stocked", "Fast dispatch"],
  },
  {
    slug: "arts-crafts",
    name: "Arts & Crafts",
    description: "Art supplies, craft materials, and handmade goods from makers.",
    hero_copy: "Make something — art and craft supplies with honest materials.",
    sort_order: 24,
    is_featured: false,
    filter_presets: ["verified", "cod"],
    trust_notes: ["Material stated", "Maker-sourced", "Gift-ready"],
  },
  {
    slug: "garden-outdoor",
    name: "Garden & Outdoor",
    description: "Garden tools, plants, and outdoor gear for the yard and beyond.",
    hero_copy: "Grow and gather — garden and outdoor goods with honest specs.",
    sort_order: 25,
    is_featured: false,
    filter_presets: ["verified", "company_owned"],
    trust_notes: ["Material stated", "Quality-checked", "Delivery notes clear"],
  },
  {
    slug: "pet-supplies",
    name: "Pet Supplies",
    description: "Food, toys, and care for the animals in the household.",
    hero_copy: "For the pets — food and supplies with clear labels and honest dates.",
    sort_order: 26,
    is_featured: false,
    filter_presets: ["verified", "cod", "fast_delivery"],
    trust_notes: ["Dates stated", "Sealed on dispatch", "COD eligible"],
  },
  {
    ...
    description: "Instruments, audio kit, and the gear that makes and records sound.",
    hero_copy: "Make music — instruments and studio gear, verified and dispatch-ready.",
    sort_order: 27,
    is_featured: false,
    filter_presets: ["verified", "company_owned"],
    trust_notes: ["Condition stated", "Tested before dispatch", "Warranty stated"],
  },
];
