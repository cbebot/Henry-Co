/**
 * PROD-READY-01: Domain-agnostic URL helper for the company-hub Expo app.
 *
 ...
 * Caller pattern:
 *
 *   import { henryDivisionUrl, henryWebOrigin, henryDivisionHost } from "@/lib/domain";
 *
 *   const care = henryDivisionUrl("care");        // https://care.henrycogroup.com
 *   const home = henryWebOrigin();                // https://www.henrycogroup.com
 *   const host = henryDivisionHost("care");       // care.henrycogroup.com (bare)
 */
