...
const PERMISSIONS_BY_FAMILY: Record<PlatformRoleFamily, WorkspacePermission[]> = {
  division_manager: [
    "workspace.view",
    "overview.view",
    "tasks.view",
...
const SHARED_PROFILE_FAMILIES: Record<string, PlatformRoleFamily[]> = {
...
const DEFAULT_HOME_DIVISIONS: Record<string, WorkspaceDivision[]> = {
