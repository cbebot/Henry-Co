...
function formatDateLabel(locale: string, value?: string | null, fallback = "Not yet") {
        ...
        <div className="space-y-6">
          <LearnPanel className="rounded-[2rem]">
            <div className="flex items-center gap-3 text-[var(--learn-copper)]">
              ...
              <p className="text-xs font-semibold uppercase tracking-[0.18em]">{t("Trust checks")}</p>
            </div>
          ...
          <LearnPanel className="rounded-[2rem]">
            ...
            <div className="mt-5 grid gap-3">
              <div className="rounded-[1.4rem] border border-[var(--learn-line)] bg-white/5 p-4">
                ...
                <p className="mt-2 text-sm leading-7 text-[var(--learn-ink-soft)]">
                  {data.enrollment?.status === "completed"
                    ? t("Enrollment is marked completed in the academy record.")
              ...
              <div className="rounded-[1.4rem] border border-[var(--learn-line)] bg-white/5 p-4">
                ...
                <p className="mt-2 text-sm leading-7 text-[var(--learn-ink-soft)]">
                  {t("This verification page is ready to be shared as the credibility surface for the credential.")}
                </p>
              </div>
            </div>
          </LearnPanel>
          ...
          {data.course ? (
            <LearnPanel className="rounded-[2rem]">
              ...
              <p className="mt-2 text-sm leading-7 text-[var(--learn-ink-soft)]">
                {t("Use the download button to print or save this certificate directly from the live verification surface.")}
              </p>
            </LearnPanel>
          ) : null}
        </div>
