    ...
    <div className="space-y-6 acct-fade-in">
      ...
      <div className="acct-card p-6">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <div className="rounded-2xl bg-[var(--acct-surface)] p-4"><p className="text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-[var(--acct-muted)]">Total</p><p className="mt-2 text-lg font-semibold text-[var(--acct-ink)]">{formatNaira(Number(invoice.total_kobo || 0))}</p></div>
          <div className="rounded-2xl bg-[var(--acct-surface)] p-4"><p className="text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-[var(--acct-muted)]">Subtotal</p><p className="mt-2 text-lg font-semibold text-[var(--acct-ink)]">{formatNaira(Number(invoice.subtotal_kobo || 0))}</p></div>
          <div className="rounded-2xl bg-[var(--acct-surface)] p-4"><p className="text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-[var(--acct-muted)]">Tax</p><p className="mt-2 text-lg font-semibold text-[var(--acct-ink)]">{formatNaira(Number(invoice.tax_kobo || 0))}</p></div>
