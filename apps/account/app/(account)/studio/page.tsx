        ...
        <div className="bg-[linear-gradient(135deg,#0F172A_0%,#7C2D12_46%,#C9A227_100%)] px-6 py-7 text-white sm:px-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              <p className="hc-label uppercase tracking-[0.2em] text-white/75">{t("Studio project room")}</p>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div key={item.label} className="rounded-2xl border border-white/15 bg-white/10 p-4 backdrop-blur-sm">
                  <div className="hc-label uppercase tracking-[0.16em] text-white/75">{item.label}</div>
                  <div className="hc-h1 hc-mono mt-3 text-white">{item.value}</div>
                  <p className="hc-body-sm mt-2 text-white/75">{item.detail}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="acct-card p-5 sm:p-6">
          <div className="mb-5 flex items-center justify-between gap-4">
            <div>
              ...
              <h3 className="hc-h3 mt-2 text-[var(--acct-ink)]">{t("Delivery lanes with real project state")}</h3>
            </div>
          </div>
        ...
        <section className="acct-card p-5 sm:p-6">
          <div className="mb-5 flex items-center justify-between gap-4">
            <div>
              ...
              <h3 className="hc-h3 mt-2 text-[var(--acct-ink)]">{t("Payments and proof visibility")}</h3>
            </div>
          </div>
        ...
        <section className="acct-card p-5 sm:p-6">
          <div className="mb-5 flex items-center justify-between gap-4">
            <div>
              ...
              <h3 className="hc-h3 mt-2 text-[var(--acct-ink)]">{t("Commercial context and follow-up")}</h3>
            </div>
          </div>
        ...
        <section className="acct-card p-5 sm:p-6">
          <div className="mb-5 flex items-center justify-between gap-4">
            <div>
              ...
              <h3 className="hc-h3 mt-2 text-[var(--acct-ink)]">{t("The fastest moves to unblock Studio work")}</h3>
            </div>
          </div>
