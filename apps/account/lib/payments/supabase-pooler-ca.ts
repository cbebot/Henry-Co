 ...
 *
 * Public certificate (not a secret). Captured from the live pooler
 * (`openssl s_client -starttls postgres`); valid 2021-04-28 → 2031-04-26.
 * If Supabase ever rotates the root, set the PAYMENTS_DB_SSL_CA env to the new
 * cert (it overrides this) — no code change needed.
 */
