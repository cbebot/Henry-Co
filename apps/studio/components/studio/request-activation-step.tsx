...
export function StudioRequestActivationStep({
  ...
  const outcomePoints = [
    "The lead, brief, and proposal path persist as real Studio records.",
    "Commercial pricing, deposit logic, and milestone structure stay consistent into delivery.",
    "Notifications, updates, files, and support continue on the same record.",
  ];

  return (
    <section className="studio-panel rounded-[2.6rem] p-6 sm:p-8">
      <div className="studio-kicker">Activation</div>
      <div className="mt-6 grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="space-y-5">
          <div className="grid gap-4 xl:grid-cols-2">
            <input name="customerName" required className="studio-input rounded-[1.2rem] px-4 py-3" placeholder="Your name" />
            <input name="companyName" className="studio-input rounded-[1.2rem] px-4 py-3" placeholder="Company or brand" />
            <input name="email" type="email" required className="studio-input rounded-[1.2rem] px-4 py-3" placeholder="you@company.com" />
            <input name="phone" className="studio-input rounded-[1.2rem] px-4 py-3" placeholder="+234..." />
          </div>
