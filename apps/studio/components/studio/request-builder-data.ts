 ...
 * sequence we follow at Henry Onyx Studio after a project is signed:
 *
...
export const requestSteps = [
  ...
  },
  {
    ...
    body: "Tick what matters. Each page or feature is a priced line-item. Choose your programming language, framework, backend, and host — or let Henry Onyx recommend.",
  },
  {
    key: "commercial",
    label: "Context",
