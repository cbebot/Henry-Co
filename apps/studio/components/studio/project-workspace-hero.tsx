...
export function ProjectWorkspaceHero({
  ...
  return (
    <section className="relative overflow-hidden rounded-[2.6rem] border border-[var(--studio-accent-soft)] bg-[linear-gradient(165deg,var(--studio-accent-soft)_0%,var(--studio-bg-soft)_45%,var(--studio-bg-soft)_100%)] px-7 py-10 shadow-[var(--studio-shadow)] sm:px-10 sm:py-12 lg:px-14 lg:py-14">
      <div
        className="pointer-events-none absolute -right-24 -top-24 h-72 w-72 rounded-full bg-[radial-gradient(circle,var(--studio-accent-soft),transparent_68%)]"
        aria-hidden
      />
      <div className="relative grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-[var(--studio-accent-soft)] bg-[var(--studio-fill-soft)] px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.2em] text-[var(--studio-signal)]">
            Client workspace
          </div>
          ...
          <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center">
            {clientCta ? (
              <a
                href={clientCta.href}
                className="studio-button-primary inline-flex items-center justify-center rounded-full px-8 py-4 text-sm font-semibold shadow-[0_16px_40px_-20px_var(--studio-accent-ring)]"
              >
                {clientCta.label}
              </a>
            ) : null}
          ...
          <div className="mt-8 rounded-[1.35rem] border border-[var(--studio-line)] bg-[var(--studio-fill-soft)] px-4 py-3 text-sm leading-7 text-[var(--studio-ink-soft)]">
            {viewer.user ? (
              <>
                Signed in as{" "}
        ...
        <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-1">
          {[
            ...
            <div
              key={card.label}
              className="rounded-[1.5rem] border border-[var(--studio-accent-soft)] bg-[var(--studio-fill-soft)] px-5 py-4 backdrop-blur-sm"
            >
