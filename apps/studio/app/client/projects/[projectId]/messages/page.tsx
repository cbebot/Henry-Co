...
export async function generateMetadata({
  ...
  if (!initial) {
    return { title: "Project conversation · Henry & Co. Studio" };
  }
  ...
  return {
    title: `${localizedProjectTitle} · Messages · Henry & Co. Studio`,
    description: `Conversation with the Henry & Co. Studio team for ${localizedProjectTitle}.`,
