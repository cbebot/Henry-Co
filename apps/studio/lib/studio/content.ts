...
export const studioDifferentiators: StudioDifferentiator[] = [
  ...
  },
  {
    ...
    description: "Projects can be routed to the best-fit Henry & Co. team based on delivery style, scope complexity, and business context.",
...
export const studioFaqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. Henry & Co. Studio covers brand systems, websites, e-commerce, internal platforms, client portals, and mobile products. The brief flow is built to route the work to the right combination of strategy, design, and engineering.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Studio sends email updates for inquiry receipt, proposals, payment checkpoints, milestone readiness, revisions, and final delivery. WhatsApp updates can also be used when the shared Henry & Co. messaging setup supports the contact path cleanly.",
  },
  {
    question: "Will this later connect to the Henry & Co. account dashboard?",
    answer:
      "Yes. Studio projects can connect with your Henry & Co. account so project history, invoices, files, and support updates stay easy to revisit.",
  },
];
...
export const studioProcess = [
  ...
  "Route the project to the best-fit Henry & Co. team or team mix.",
...
export const studioTrustSignals = [
  ...
  "Henry & Co. account history is designed to keep proposals, projects, payments, documents, and support context in one place.",
];
