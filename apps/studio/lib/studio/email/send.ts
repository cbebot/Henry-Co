...
export async function sendInquiryNotifications(input: {
  ...
  const layout: EmailLayout = {
    ...
    title: "Your studio brief is now inside Henry & Co. Studio.",
    intro:
  ...
  await sendWhatsApp({
    ...
    body: [
      `Henry & Co. Studio • ${input.lead.customerName}`,
...
export async function sendProposalNotifications(input: {
  ...
  await renderAndSendEmail({
    ...
    layout: {
      ...
      intro:
        "Henry & Co. Studio generated the first proposal so you can review investment, team fit, and milestone logic without waiting for a shallow follow-up thread.",
...
export async function sendProjectStartedNotifications(input: {
  ...
  await renderAndSendEmail({
    ...
    layout: {
      ...
      title: "Your Henry & Co. Studio workspace is now live.",
      intro:
...
export async function sendPaymentInstructionsNotifications(input: {
  ...
  await renderAndSendEmail({
    ...
    layout: {
      ...
      bullets: [
        ...
        "Henry & Co. finance confirms the payment before delivery moves into the next milestone.",
      ],
  ...
  await sendWhatsApp({
    ...
    locale: recipientLocale,
    body: [
      `Henry & Co. Studio • ${input.project.title}`,
...
export async function sendProposalDecisionNotifications(input: {
  ...
  await renderAndSendEmail({
    ...
    layout: {
      ...
      intro: accepted
        ? "Henry & Co. Studio has recorded acceptance against this proposal. The next step is activating or reviewing the project workspace and deposit lane."
        : "Henry & Co. Studio has recorded this proposal as rejected so the commercial record stays accurate. The proposal history remains available if the scope needs to reopen later.",
...
export async function sendDepositReceivedNotifications(input: {
  ...
  await renderAndSendEmail({
    ...
    layout: {
      ...
      intro:
        "Henry & Co. Studio has recorded the payment against the active project lane and updated the execution state accordingly.",
...
export async function sendMilestoneReadyNotifications(input: {
  ...
  await sendWhatsApp({
    ...
    locale: recipientLocale,
    body: [
      `Henry & Co. Studio • ${input.milestone.name}`,
...
export async function sendRevisionRequestedNotifications(input: {
  ...
  await renderAndSendEmail({
    ...
    layout: {
      ...
      intro:
        "Henry & Co. Studio logged the revision as a formal delivery item so it stays visible to the team and to you.",
      sections: [
...
export async function sendFinalDeliveryNotifications(input: {
  ...
  await renderAndSendEmail({
    ...
    layout: {
      ...
      intro:
        "Henry & Co. Studio has moved the project into final delivery. The last review rail, files, and approval state are now visible in the workspace.",
...
export async function sendProjectUpdateNotifications(input: {
  ...
  await renderAndSendEmail({
    ...
    layout: {
      ...
      intro:
        "Henry & Co. Studio recorded a project update against your workspace so the latest movement, handoff, or review context stays visible and timestamped.",
      sections: [
        { label: "Project", value: input.project.title },
...
export async function sendPaymentReminderNotification(input: {
  ...
  await sendWhatsApp({
    ...
    locale: recipientLocale,
    body: [
      `Henry & Co. Studio • ${input.payment.label}`,
...
export async function sendSupportReplyNotification(input: {
  ...
  await renderAndSendEmail({
    ...
    layout: {
      ...
      title: "Henry & Co. Studio replied to your support request.",
      intro:
        "Your support conversation has a new reply. The thread remains attached to your Henry & Co. support history so payment, delivery, and project clarification stay in one place.",
      sections: [
  ...
  await sendWhatsApp({
    ...
    locale: recipientLocale,
    body: [
      tw("Henry & Co. Studio support replied to your thread."),
      input.subject,
      input.body,
