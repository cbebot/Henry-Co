...
export function normalizeStudioPlatformSettings(
  ...
  return {
    ...
    paymentInstructions: asText(
      ...
      "Transfer the exact amount shown below, upload proof immediately inside the project workspace, and Henry Onyx finance confirms the payment before delivery advances."
    ),
    paymentSupportEmail,
